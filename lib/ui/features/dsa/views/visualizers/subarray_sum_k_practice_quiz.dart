...
class SubarraySumKPracticeQuiz extends StatefulWidget {
  final bool isEnglish;

  const SubarraySumKPracticeQuiz({
    super.key,
    required this.isEnglish,
  });

  @override
  State<SubarraySumKPracticeQuiz> createState() =>
      _SubarraySumKPracticeQuizState();
}
...
class _SubarraySumKPracticeQuizState
    extends State<SubarraySumKPracticeQuiz> {
  int _activeSubTab = 0;
  ...
  final List<TestCaseData> _testCases = const [
    TestCaseData(inputStr: "nums = [1,1,1], k = 2", expectedOutputStr: "count = 2"),
    TestCaseData(inputStr: "nums = [1,2,3], k = 3", expectedOutputStr: "count = 2"),
    TestCaseData(inputStr: "nums = [1,-1,0], k = 0", expectedOutputStr: "count = 3"),
  ];
  ...
  final List<QuizQuestion> _quizQuestions = const [
    QuizQuestion(
      questionEn: "1. Why must we initialize `prefixMap[0] = 1` before processing elements?",
      questionBn: "১. এলিমেন্ট লুপ শুরু করার আগে কেন `prefixMap[0] = 1` সেভ করে নিতে হয়?",
      optionsEn: [
        "A) To account for continuous subarrays starting right from index 0 whose sum equals K exactly!",
        "B) To clear previous memory values",
        "C) To prevent null key exceptions",
        "D) It initializes the array size"
      ],
      optionsBn: [
        "A) যাতে ইনডেক্স ০ থেকে শুরু হওয়া সাবঅ্যারে যার মোট সাম K এর সমান তা সঠিকভাবে গণনায় আসে!",
        "B) পূর্ববর্তী মেমোরি ক্লিয়ার করতে",
        "C) নাল কী এক্সেপশন আটকাতে",
        "D) অ্যারের সাইজ সূচনা করতে"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! If a running sum equals K directly, `sum - K` equals 0. Having `mp[0] = 1` counts this subarray from index 0!",
      explanationBn: "সঠিক! যদি রানিং সাম সরাসরি K এর সমান হয়, তবে `sum - K` = 0 হয়। `mp[0] = 1` থাকায় এই সাবঅ্যারেটি সঠিকভাবে গণনায় আসে।",
    ),
    QuizQuestion(
      questionEn: "2. Why does Sliding Window (Two Pointers) fail for Subarray Sum Equals K when negative numbers exist in the array?",
      questionBn: "২. অ্যারেতে ঋণাত্মক (Negative) সংখ্যা থাকলে কেন স্লাইডিং উইন্ডো (Two Pointers) কাজ করে না?",
      optionsEn: [
        "A) Negative numbers violate monotonic sum growth, making right pointer expansion non-predictable!",
        "B) Two pointers only work on strings",
        "C) Negative numbers cause overflow",
        "D) Hash Maps become invalid"
      ],
      optionsBn: [
        "A) ঋণাত্মক সংখ্যা যোগ করলে সাম কমে যেতে পারে, ফলে রানিং সাম মনোটোনিক থাকে না!",
        "B) টু পয়েন্টার কেবল স্ট্রিংয়ে কাজ করে",
        "C) ঋণাত্মক সংখ্যা ওভারফ্লো তৈরি করে",
        "D) হ্যাশ ম্যাপ ইনভ্যালিড হয়ে পড়ে"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! Sliding window assumes expanding right increases sum and shrinking left decreases sum. Negative numbers break this assumption, necessitating Prefix Sum + Hash Map.",
      explanationBn: "সঠিক! স্লাইডিং উইন্ডো ধরে নেয় উইন্ডো বাড়ালে সাম বাড়ে ও কমালে কমে। ঋণাত্মক সংখ্যা থাকলে এ ধারণা ভুল প্রমাণিত হয়।",
    ),
  ];
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            widget.isEnglish ? "Subarray Sum K Quiz" : "সাবঅ্যারে সাম K কুইজ",
                            overflow: TextOverflow.ellipsis,
                            maxLines: 1,
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      widget.isEnglish ? "Subarray Sum Equals K Test Runner" : "সাবঅ্যারে সাম K টেস্ট রানার",
              ...
              Text(
                widget.isEnglish
                    ? "Verify prefix sum hash map subarray counting logic with positive and zero/negative elements."
                    : "প্রেফিক্স সাম হ্যাশ ম্যাপ লজিক বিভিন্ন টেস্ট কেসে ভেরিফাই করুন।",
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.isEnglish ? "Subarray Sum K Mastery Quiz" : "সাবঅ্যারে সাম K মাস্টার কুইজ",
