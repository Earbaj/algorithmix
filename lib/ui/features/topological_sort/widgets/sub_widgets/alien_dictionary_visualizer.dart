...
import 'kahns_algorithm_visualizer.dart';

class AlienDictionaryVisualizer extends StatefulWidget {
  final bool isEnglish;

  const AlienDictionaryVisualizer({super.key, required this.isEnglish});

  @override
  State<AlienDictionaryVisualizer> createState() => _AlienDictionaryVisualizerState();
}

class _AlienDictionaryVisualizerState extends State<AlienDictionaryVisualizer> {
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              const Text("Alien Dictionary Ordering", style: TextStyle(color: AppTheme.accentNeonCyan, fontWeight: FontWeight.bold, fontSize: 13)),
              Text("Result: \"wert\"", style: const TextStyle(color: AppTheme.accentGreen, fontWeight: FontWeight.bold, fontSize: 12)),
            ],
          ),
          const SizedBox(height: 16),
          Container(
            ...
            child: Column(
              children: [
                const Text("Alphabetical Sequence Order:", style: TextStyle(color: AppTheme.textSecondary, fontSize: 12)),
                const SizedBox(height: 8),
                Text("\"w -> e -> r -> t\"", style: const TextStyle(color: AppTheme.accentGreen, fontWeight: FontWeight.bold, fontSize: 20)),
              ],
            ),
          ),
        ],
