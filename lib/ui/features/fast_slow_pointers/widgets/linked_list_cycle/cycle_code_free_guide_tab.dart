...
class _CycleCodeFreeGuideTabState extends State<CycleCodeFreeGuideTab> {
  ...
  final List<int> _animGuideNodes = [3, 2, 0, -4];
  ...
  Widget build(BuildContext context) {
    ...
    if (_animGuideStep == 0) {
      slowIdx = 0;
      fastIdx = 0;
      stepTextEn = "Start: Both Slow (🐢) and Fast (🐇) start at Head (Node 0 [val: 3]).";
      stepTextBn = "শুরু: Slow (🐢) এবং Fast (🐇) দুজনই শুরুতে নোড 0 [মান: 3] এ অবস্থান করছে।";
    } else if (_animGuideStep == 1) {
      slowIdx = 1;
      fastIdx = 2;
      stepTextEn = "Step 1: Slow moves 1 step → Node 1 [val: 2]. Fast moves 2 steps → Node 2 [val: 0].";
      stepTextBn = "ধাপ ১: Slow ১ ধাপ হেঁটে নোড ১ [মান: 2] এ। Fast ২ ধাপ হেঁটে নোড ২ [মান: 0] এ।";
    } else if (_animGuideStep == 2) {
      slowIdx = 2;
      fastIdx = 1;
      stepTextEn = "Step 2: Slow moves 1 step → Node 2 [val: 0]. Fast wraps around cycle (+2 steps) → Node 1 [val: 2].";
      stepTextBn = "ধাপ ২: Slow ১ ধাপ হেঁটে নোড ২ [মান: 0] এ। Fast সাইকেল ঘুরে ২ ধাপ হেঁটে নোড ১ [মান: 2] এ।";
    } else {
      slowIdx = 3;
      fastIdx = 3;
      stepTextEn = "🎉 COLLISION MATCH! Both Slow and Fast meet at Node 3 [val: -4] inside the cycle! Return true!";
      stepTextBn = "🎉 মিলন ঘটেছে! সাইকেলের ভেতর উভয় পয়েন্টার নোড ৩ [মান: -4] এ মিলিত হয়েছে! Return true!";
    }
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    widget.isEnglish
                        ? "Watch how Slow (🐢 1 step) and Fast (🐇 2 steps) race inside a linked list with a cycle. Inside a cycle, Fast reduces the distance by 1 node per turn until it laps Slow and collides!"
                        : "দেখুন কিভাবে সাইকেল যুক্ত লিঙ্কড লিস্টে Slow (🐢 ১ ধাপ) এবং Fast (🐇 ২ ধাপ) পয়েন্টার লুপ ঘুরছে। সাইকেলের ভেতর প্রতি ধাপে গ্যাপ ১ নোড করে কমে এবং শেষমেশ মিলন ঘটে!",
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Text(
                        "Linked List Cycle Track: [3, 2, 0, -4] (pos: 1)",
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: List.generate(_animGuideNodes.length, (idx) {
                        ...
                        final isCollision = _animGuideStep == 3 && isSlow && isFast;
                        ...
                        return AnimatedContainer(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text('$val', style: TextStyle(fontSize: Responsive.sp(context, 18), fontWeight: FontWeight.bold, color: isCollision ? AppTheme.accentGreen : Colors.white)),
