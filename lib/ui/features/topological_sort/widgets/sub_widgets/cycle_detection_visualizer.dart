      ...
      child: Column(
        ...
        children: [
          const Row(
            ...
            children: [
              Text("Cycle Detection Check", style: TextStyle(color: AppTheme.accentNeonCyan, fontWeight: FontWeight.bold, fontSize: 13)),
              Text("No Cycle", style: TextStyle(color: AppTheme.accentGreen, fontWeight: FontWeight.bold, fontSize: 12)),
            ],
          ),
          const SizedBox(height: 16),
          Container(
            ...
            child: Column(
              children: [
                const Text("Processed Nodes Count == Total Vertices:", style: TextStyle(color: AppTheme.textSecondary, fontSize: 12)),
                const SizedBox(height: 8),
                Text("${step.topologicalOrder.length} == ${step.topologicalOrder.length}", style: const TextStyle(color: AppTheme.accentGreen, fontWeight: FontWeight.bold, fontSize: 18)),
              ],
            ),
          ),
        ],
