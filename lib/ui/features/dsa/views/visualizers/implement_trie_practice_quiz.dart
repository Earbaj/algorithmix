...
class ImplementTriePracticeQuiz extends StatefulWidget {
  final bool isEnglish;

  const ImplementTriePracticeQuiz({
    super.key,
    required this.isEnglish,
  });

  @override
  State<ImplementTriePracticeQuiz> createState() =>
      _ImplementTriePracticeQuizState();
}
...
class _ImplementTriePracticeQuizState
    extends State<ImplementTriePracticeQuiz> {
  int _activeSubTab = 0;
  ...
  final List<TestCaseData> _testCases = const [
    TestCaseData(inputStr: "insert(\"apple\"), search(\"apple\"), search(\"app\"), startsWith(\"app\")", expectedOutputStr: "true, false, true"),
    TestCaseData(inputStr: "insert(\"app\"), search(\"app\")", expectedOutputStr: "true"),
    TestCaseData(inputStr: "search(\"random\")", expectedOutputStr: "false"),
  ];
  ...
  final List<QuizQuestion> _quizQuestions = const [
    QuizQuestion(
      questionEn: "1. What is the time complexity of searching a word of length L in a Trie containing N total words?",
      questionBn: "১. N টি মোট শব্দ ধারণকারী ট্রাইতে L দৈর্ঘ্যের একটি শব্দ খোঁজার টাইম জটিলতা কত?",
      optionsEn: [
        "A) O(L) - Bound strictly by word length L, independent of N!",
        "B) O(N * L)",
        "C) O(log N)",
        "D) O(26^L)"
      ],
      optionsBn: [
        "A) O(L) - ডিকশনারির মোট শব্দ N এর ওপর নির্ভরশীল নয়, কেবল শব্দ দৈর্ঘ্য L!",
        "B) O(N * L)",
        "C) O(log N)",
        "D) O(26^L)"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! Trie search traverses exactly L child pointers from top to bottom, executing in deterministic O(L) time.",
      explanationBn: "সঠিক! ট্রাই সার্চ সর্বোচ্চ L সংখ্যক ক্যারেক্টার নোড স্ক্যান করায় ওয়ান O(L) সময় লাগে।",
    ),
    QuizQuestion(
      questionEn: "2. Why is `isEndOfWord` boolean flag essential in Trie nodes?",
      questionBn: "২. ট্রাই নোডে `isEndOfWord` বুলিয়ান ফ্ল্যাগ কেন আবশ্যক?",
      optionsEn: [
        "A) To distinguish between an exact standalone word (e.g. 'app') vs a prefix shared by longer words (e.g. 'apple')!",
        "B) To calculate tree height",
        "C) To count child nodes",
        "D) It is an optional flag"
      ],
      optionsBn: [
        "A) কোনো স্ট্রিং কি শুধুই প্রিফিক্স ('app' in 'apple') নাকি নিজে একটি পূর্ণাঙ্গ শব্দ ('app') তা আলাদা করতে!",
        "B) ট্রির উচ্চতা গণনা করতে",
        "C) চাইল্ড নোড গণনা করতে",
        "D) এটি একটি ঐচ্ছিক ফ্ল্যাগ"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! Without `isEndOfWord`, searching 'app' when only 'apple' is inserted would incorrectly return true.",
      explanationBn: "সঠিক! `isEndOfWord` না থাকলে 'apple' ইনসার্ট করা থাকলে 'app' সার্চ করলেও সত্য দেখাত।",
    ),
  ];
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            widget.isEnglish ? "Trie Quiz" : "ট্রাই কুইজ",
                            overflow: TextOverflow.ellipsis,
                            maxLines: 1,
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      widget.isEnglish ? "Implement Trie Test Runner" : "ট্রাই টেস্ট রানার",
              ...
              Text(
                widget.isEnglish
                    ? "Verify insert, search, and startsWith operations in Trie Prefix Tree."
                    : "ট্রাই ডেটা স্ট্রাকচারের insert, search ও startsWith মেথডগুলো টেস্ট করুন।",
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.isEnglish ? "Implement Trie Mastery Quiz" : "ট্রাই মাস্টার কুইজ",
