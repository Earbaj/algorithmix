...
class _SubsetsBacktrackingDetailScreenState extends State<SubsetsBacktrackingDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(_isEnglish ? 'Subsets & Backtracking Deep Dive' : 'Subsets & Backtracking গাইড'),
        centerTitle: true,
        actions: [
          Padding(
      ...
      body: TabBarView(
        controller: _tabController,
        children: [
          SubsetsConceptTabView(intro: intro, isEnglish: _isEnglish),
          SubsetsVisualizerTabView(isEnglish: _isEnglish),
          SubsetsProblemsTabView(isEnglish: _isEnglish),
          SubsetsMistakesTabView(isEnglish: _isEnglish),
        ],
      ),
    );
  }
