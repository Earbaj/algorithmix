...
class _CycleSolutionCodeTabState extends State<CycleSolutionCodeTab> {
  ...
  int _userSlow = 0;
  int _userFast = 0;
  String _userFeedbackEn =
      "Advance pointers: Slow moves 1 step, Fast moves 2 steps!";
  String _userFeedbackBn =
      "পয়েন্টার অগ্রসর করুন: Slow ১ ধাপ, Fast ২ ধাপ যাবে!";
  ...
  void _handleUserMove() {
    ...
    setState(() {
      ...
      if (_cyclePos >= 0 && _userSlow == _userFast) {
        _userSolved = true;
        _userFeedbackEn =
            "🎉 CONGRATULATIONS! Pointers collided at index $_userSlow (val: ${_currentNodes[_userSlow % n]})! Cycle detected!";
        _userFeedbackBn =
            "🎉 অভিনন্দন! পয়েন্টারদ্বয় ইনডেক্স $_userSlow এ মিলিত হয়েছে! সাইকেল ডিটেকশন নিশ্চিত!";
      } else if (_cyclePos < 0 && _userFast >= n) {
        _userSolved = true;
        _userFeedbackEn =
            "✅ Fast reached end of list without cycle! Return false.";
        _userFeedbackBn =
            "✅ Fast লিঙ্কড লিস্টের শেষ মাথায় নাল পেয়েছে! কোনো সাইকেল নেই।";
      } else {
        _userFeedbackEn =
            "Step done: Slow is at index $_userSlow, Fast is at index $_userFast. Keep moving!";
        _userFeedbackBn =
            "ধাপ সম্পন্ন: Slow ইনডেক্স $_userSlow এ, Fast ইনডেক্স $_userFast এ। পয়েন্টার চালান!";
      }
    });
  }
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                      widget.isEnglish
                          ? 'Practice Mode: Move Pointers Yourself!'
                  ...
                  Text(
                      widget.isEnglish
                          ? 'Current List: $_currentNodes | Cycle Pos: $_cyclePos'
                          : 'বর্তমান লিস্ট: $_currentNodes | সাইকেল ইনডেক্স: $_cyclePos',
                      style: TextStyle(
                  ...
                  Wrap(
                    ...
                    children: [
                      ElevatedButton.icon(
                        ...
                        label: Text(
                            widget.isEnglish
                                ? 'Advance Pointers (Slow +1, Fast +2)'
                                : 'পয়েন্টার অগ্রসর করুন (Slow +১, Fast +২)',
                            style: TextStyle(
                                fontSize: Responsive.sp(context, 13))),
                      ...
                      OutlinedButton.icon(
                        onPressed: () {
                          setState(() {
                            ...
                            _userSolved = false;
                            _userFeedbackEn =
                                "Reset done! Try moving pointers.";
                  ...
                  Container(
                    ...
                    child: Text(
                        widget.isEnglish ? _userFeedbackEn : _userFeedbackBn,
                        style: TextStyle(
                            color: _userSolved
                                ? AppTheme.accentGreen
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                      widget.isEnglish
                          ? "Official optimal solution in C++, Java, Python & JavaScript."
                          : "C++, Java, Python এবং JavaScript ভাষায় সলিউশন।",
                      style: TextStyle(
                  ...
                  ElevatedButton(
                    ...
                    child: Text(
                        _showAnswer
                            ? (widget.isEnglish ? "Hide Code" : "কোড লুকান")
                            : (widget.isEnglish
