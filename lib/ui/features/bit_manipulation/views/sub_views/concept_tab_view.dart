...
class BitConceptTabView extends StatelessWidget {
  final Map<String, String> intro;
  final bool isEnglish;

  const BitConceptTabView({
    super.key,
    required this.intro,
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            // 3 Main Bit Manipulation Patterns
            Text(
              intro["typesTitle"]!,
              style: TextStyle(
            ...
            const SizedBox(height: 12),
            _buildCodeBox("Template 1: Single Number (XOR Cancellation)", """
int singleNumber(vector<int>& nums) {
    ...
    return result; // Unique single element remaining!
            ...
            _buildCodeBox("Template 2: Brian Kernighan's 1-Bits Count (n & n - 1)", """
int hammingWeight(uint32_t n) {
    ...
    return count;
            ...
            const SizedBox(height: 16),
            _buildCodeBox("Template 3: 32-Bit Reverse Bits", """
