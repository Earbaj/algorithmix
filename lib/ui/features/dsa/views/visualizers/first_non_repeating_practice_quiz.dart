...
class FirstNonRepeatingPracticeQuiz extends StatefulWidget {
  final bool isEnglish;

  const FirstNonRepeatingPracticeQuiz({
    super.key,
    required this.isEnglish,
  });

  @override
  State<FirstNonRepeatingPracticeQuiz> createState() =>
      _FirstNonRepeatingPracticeQuizState();
}
...
class _FirstNonRepeatingPracticeQuizState
    extends State<FirstNonRepeatingPracticeQuiz> {
  int _activeSubTab = 0;
  ...
  final List<TestCaseData> _testCases = const [
    TestCaseData(inputStr: "stream = \"aabccxb\"", expectedOutputStr: "res = \"a#bccxb\""),
    TestCaseData(inputStr: "stream = \"zzzz\"", expectedOutputStr: "res = \"z###\""),
    TestCaseData(inputStr: "stream = \"abc\"", expectedOutputStr: "res = \"aaa\""),
  ];
  ...
  final List<QuizQuestion> _quizQuestions = const [
    QuizQuestion(
      questionEn: "1. Why is a Queue (FIFO) combined with a Frequency Map essential for First Non-Repeating character in stream?",
      questionBn: "১. স্ট্রিম থেকে প্রথম অনাবৃত্ত ক্যারেক্টার বের করতে কিউ (FIFO) ও ফ্রিকোয়েন্সি ম্যাপের সংমিশ্রণ কেন প্রয়োজনীয়?",
      optionsEn: [
        "A) Queue preserves arrival time order (FIFO); Frequency Map tracks repeat counts so repeated front items can be popped!",
        "B) It sorts characters alphabetically",
        "C) It requires O(N^2) memory",
        "D) Frequency map alone is enough without queue"
      ],
      optionsBn: [
        "A) কিউ আসার সময়ক্রম (FIFO) সংরক্ষণ করে; ম্যাপ পুনরাবৃত্তি গণনা করে যাতে ফ্রন্টের ডুপ্লিকেট ক্যারেক্টার পপ করা যায়!",
        "B) এটি ক্যারেক্টার বর্ণানুক্রমিকভাবে সাজায়",
        "C) এতে O(N^2) মেমোরি লাগে",
        "D) কিউ ছাড়াই কেবল ফ্রিকোয়েন্সি ম্যাপ যথেষ্ট"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! The Queue tracks the exact order in which characters entered the stream, ensuring `q.front()` is always the earliest non-repeating character.",
      explanationBn: "সঠিক! স্ট্রিমে ক্যারেক্টারগুলো আসার সঠিক ফার্স্ট-ইন ফার্স্ট-আউট সিকুয়েন্স কিউ ধরে রাখে।",
    ),
    QuizQuestion(
      questionEn: "2. What happens when `freq[q.front()] > 1` inside the while loop?",
      questionBn: "২. while লুপের ভেতর `freq[q.front()] > 1` হলে কী ঘটে?",
      optionsEn: [
        "A) The front element is no longer non-repeating, so it is POPPED from the Queue!",
        "B) The stream is terminated",
        "C) The character is appended to output",
        "D) The queue is cleared"
      ],
      optionsBn: [
        "A) ফ্রন্টের উপাদানটি ডুপ্লিকেট হয়ে যাওয়ায় তা কিউ থেকে POP করা হয়!",
        "B) স্ট্রিম বন্ধ করে দেওয়া হয়",
        "C) ক্যারেক্টার আউটপুটে যোগ করা হয়",
        "D) কিউ সম্পূর্ণ খালি করা হয়"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! If `freq[q.front()] > 1`, that character is duplicated and can never be the first non-repeating character, so it is safely discarded from the front.",
      explanationBn: "সঠিক! `freq[q.front()] > 1` হওয়ার অর্থ সেটি পুনরাবৃত্ত, তাই ফ্রন্ট থেকে বাতিল করা হয়।",
    ),
  ];
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            widget.isEnglish ? "Stream Queue Quiz" : "স্ট্রিম কিউ কুইজ",
                            overflow: TextOverflow.ellipsis,
                            maxLines: 1,
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      widget.isEnglish ? "Character Stream Test Runner" : "ক্যারেক্টার স্ট্রিম টেস্ট রানার",
              ...
              Text(
                widget.isEnglish
                    ? "Verify stream first non-repeating character logic across single, repeating, and mixed streams."
                    : "অনাবৃত্ত ক্যারেক্টার ডিটেকশন স্ট্রিম লজিক বিভিন্ন টেস্ট কেসে ভেরিফাই করুন।",
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.isEnglish ? "Stream Queue Mastery Quiz" : "স্ট্রিম কিউ মাস্টার কুইজ",
