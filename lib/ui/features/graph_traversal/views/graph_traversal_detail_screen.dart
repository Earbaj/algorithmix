...
class _GraphTraversalDetailScreenState extends State<GraphTraversalDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(_isEnglish ? 'Graph Traversal (BFS/DFS) Deep Dive' : 'Graph Traversal (BFS/DFS) গাইড'),
        centerTitle: true,
        actions: [
          Padding(
      ...
      body: TabBarView(
        controller: _tabController,
        children: [
          GraphConceptTabView(intro: intro, isEnglish: _isEnglish),
          GraphVisualizerTabView(isEnglish: _isEnglish),
          GraphProblemsTabView(isEnglish: _isEnglish),
          GraphMistakesTabView(isEnglish: _isEnglish),
        ],
      ),
    );
  }
