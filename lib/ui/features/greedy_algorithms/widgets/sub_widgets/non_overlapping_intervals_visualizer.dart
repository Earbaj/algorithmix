...
import 'jump_game_visualizer.dart';

class NonOverlappingIntervalsVisualizer extends StatefulWidget {
  final bool isEnglish;

  const NonOverlappingIntervalsVisualizer({super.key, required this.isEnglish});

  @override
  State<NonOverlappingIntervalsVisualizer> createState() => _NonOverlappingIntervalsVisualizerState();
}

class _NonOverlappingIntervalsVisualizerState extends State<NonOverlappingIntervalsVisualizer> {
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              const Text("Interval Scheduling", style: TextStyle(color: AppTheme.accentNeonCyan, fontWeight: FontWeight.bold, fontSize: 13)),
              Text("Overlap Count: [${step.stateVal}]", style: const TextStyle(color: AppTheme.accentPink, fontWeight: FontWeight.bold, fontSize: 12)),
            ],
          ),
          const SizedBox(height: 16),
          Container(
            ...
            child: Column(
              children: [
                const Text("Minimum Removals Needed:", style: TextStyle(color: AppTheme.textSecondary, fontSize: 12)),
                const SizedBox(height: 8),
                Text("${step.stateVal}", style: const TextStyle(color: AppTheme.accentPink, fontWeight: FontWeight.bold, fontSize: 22)),
              ],
            ),
          ),
        ],
