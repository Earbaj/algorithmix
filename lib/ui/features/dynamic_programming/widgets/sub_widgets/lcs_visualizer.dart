...
class LCSVisualizer extends StatefulWidget {
  ...
  const LCSVisualizer({super.key, required this.isEnglish});

  @override
  State<LCSVisualizer> createState() => _LCSVisualizerState();
}
...
class _LCSVisualizerState extends State<LCSVisualizer> {
  ...
  final List<DPStep> _steps = const [
    DPStep(
      ...
      activeLineIndex: 5,
      dpTable: [0, 1, 2, 3],
      explanationEn: "Line 6: Character match text1[i-1] == text2[j-1]. 1 + dp[i-1][j-1].",
      explanationBn: "লাইন ৬: অক্ষর মিলেছে text1[i-1] == text2[j-1]। 1 + dp[i-1][j-1]।",
    ),
    DPStep(
      activeIndex: 3,
      activeLineIndex: 9,
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              const Text("2D Sequence LCS DP", style: TextStyle(color: AppTheme.accentNeonCyan, fontWeight: FontWeight.bold, fontSize: 13)),
              Text("LCS Length: [${step.dpTable.last}]", style: const TextStyle(color: AppTheme.accentGreen, fontWeight: FontWeight.bold, fontSize: 12)),
            ],
          ),
          const SizedBox(height: 16),
          Container(
            ...
            child: Column(
              children: [
                const Text("Longest Common Subsequence Result:", style: TextStyle(color: AppTheme.textSecondary, fontSize: 12)),
                const SizedBox(height: 8),
                Text("${step.dpTable.last}", style: const TextStyle(color: AppTheme.accentGreen, fontWeight: FontWeight.bold, fontSize: 22)),
              ],
            ),
          ),
        ],
