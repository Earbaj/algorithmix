...
import 'package:algorithmix/domain/models/two_heaps_data.dart';
...
class _TwoHeapsDetailScreenState extends State<TwoHeapsDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(_isEnglish ? 'Two Heaps Pattern Deep Dive' : 'টু হিপস (Two Heaps) গাইড'),
        centerTitle: true,
        actions: [
          Padding(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildCodeBox("Template 1: Find Median from Data Stream (C++ LeetCode 295)", """
class MedianFinder {
...
public:
    ...
    double findMedian() {
        ...
        return (maxHeap.top() + minHeap.top()) / 2.0; // O(1) Query!
            ...
            _buildCodeBox("Template 2: IPO / Maximize Capital (C++ LeetCode 502)", """
int findMaximizedCapital(int k, int w, vector<int>& profits, vector<int>& capital) {
    ...
    for (int i = 0; i < k; i++) {
        ...
        w += maxProfit.top(); maxProfit.pop(); // Max profit!
    }
    return w;
}"""),
            const SizedBox(height: 16),
            _buildCodeBox("Template 3: Sliding Window Median (C++ LeetCode 480)", """
vector<double> medianSlidingWindow(vector<int>& nums, int k) {
    ...
    // Sliding window median calculation with dual sets
    return res;
}"""),
            const SizedBox(height: 24),
          ],
  ...
  Widget _buildVisualizerTab() {
    ...
    return ResponsiveCenter(
      padding: EdgeInsets.all(hPadding),
      child: SingleChildScrollView(
        child: TwoHeapsVisualizer(isEnglish: _isEnglish),
      ),
    );
  }
  ...
  Widget _buildProblemSection(String title, List<TwoHeapsProblem> problems, Color diffColor) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Widget _buildProblemCard(TwoHeapsProblem p, Color diffColor) {
    return Container(
  ...
  Widget _buildMistakesTab() {
    final hPadding = Responsive.horizontalPadding(context);
    final mistakes = TwoHeapsData.getCommonMistakes(_isEnglish);
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildRoadmapStep(1, _isEnglish ? "Master C++ Priority Queue Syntax" : "C++ প্রাইয়োরিটি ক্যু সিনট্যাক্স আয়ত্তকরণ", _isEnglish ? "Understand Max-Heap priority_queue<int> and Min-Heap with greater<int>." : "Max-Heap ও greater<int> Min-Heap সিনট্যাক্স আয়ত্ত করুন।"),
            _buildRoadmapStep(2, _isEnglish ? "Master Dual Heap Balancing Invariant" : "ডুয়াল হিপ ব্যালেন্সিং নিয়ম", _isEnglish ? "Rebalance so maxHeap size equals minHeap size or minHeap size + 1." : "maxHeap ও minHeap সাইজের পার্থক্য ১ এর ভেতর রাখুন।"),
            _buildRoadmapStep(3, _isEnglish ? "Master O(1) Median Query Calculation" : "O(1) সময়ে মিডিয়ান গণনা", _isEnglish ? "Query median in O(1) using maxHeap.top() or average of both tops." : "O(1) সময়ে রিয়েল-টাইম মিডিয়ান হিসাব করুন।"),
            _buildRoadmapStep(4, _isEnglish ? "Master IPO Capital Maximization Pattern" : "IPO ক্যাপিটাল ম্যাক্সিমাইজেশন প্যাটার্ন", _isEnglish ? "Sort capital with Min-Heap and profit with Max-Heap." : "Min-Heap ক্যাপিটাল ও Max-Heap প্রফিট দিয়ে সর্বোচ্চ লাভ পান।"),
            _buildRoadmapStep(5, _isEnglish ? "Master Sliding Window Median with Lazy Removal" : "স্লাইডিং উইন্ডো মিডিয়ান ও ল্যাজি রিমুভাল", _isEnglish ? "Use std::multiset or Hash Map lazy removal for window K median." : "ল্যাজি রিমুভাল দিয়ে স্লাইডিং উইন্ডো মিডিয়ান সমাধান করুন।"),
            const SizedBox(height: 24),
          ],
        ),
      ),
