...
class TwoPointersConceptTabView extends StatelessWidget {
  final Map<String, String> intro;
  final bool isEnglish;

  const TwoPointersConceptTabView({
    super.key,
    required this.intro,
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildCodeBox("Template 1: Opposite Direction (Two Sum II)", """
vector<int> twoSum(vector<int>& arr, int target) {
   ...
   return {-1, -1};
            ...
            _buildCodeBox("Template 2: Same Direction Slow/Fast (Move Zeroes)", """
void moveZeroes(vector<int>& nums) {
    ...
    for (int fast = 0; fast < nums.size(); fast++) {
        if (nums[fast] != 0) {
            ...
            const SizedBox(height: 16),
            _buildCodeBox("Template 3: Fixed + Two Pointer (3Sum)", """
