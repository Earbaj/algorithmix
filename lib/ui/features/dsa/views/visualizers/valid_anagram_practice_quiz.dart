...
class ValidAnagramPracticeQuiz extends StatefulWidget {
  final bool isEnglish;

  const ValidAnagramPracticeQuiz({
    super.key,
    required this.isEnglish,
  });

  @override
  State<ValidAnagramPracticeQuiz> createState() =>
      _ValidAnagramPracticeQuizState();
}
...
class _ValidAnagramPracticeQuizState
    extends State<ValidAnagramPracticeQuiz> {
  int _activeSubTab = 0;
  ...
  final List<TestCaseData> _testCases = const [
    TestCaseData(inputStr: "s = \"anagram\", t = \"nagaram\"", expectedOutputStr: "True"),
    TestCaseData(inputStr: "s = \"rat\", t = \"car\"", expectedOutputStr: "False"),
    TestCaseData(inputStr: "s = \"listen\", t = \"silent\"", expectedOutputStr: "True"),
  ];
  ...
  final List<QuizQuestion> _quizQuestions = const [
    QuizQuestion(
      questionEn: "1. What is the time complexity of checking Valid Anagram using a Hash Map or 26-element array?",
      questionBn: "১. হ্যাশ ম্যাপ বা ২৬-উপাদানের অ্যারে ব্যবহার করে এনগ্রাম ভেরিফাই করার সময় জটিলতা কত?",
      optionsEn: ["A) O(N) linear time", "B) O(N log N)", "C) O(N^2)", "D) O(1)"],
      optionsBn: ["A) O(N) লিনিয়ার সময়", "B) O(N log N)", "C) O(N^2)", "D) O(1)"],
      correctOptionIndex: 0,
      explanationEn: "Correct! Iterating through both strings of length N once and updating counts takes O(N) linear time.",
      explanationBn: "সঠিক! N দৈর্ঘ্যের স্ট্রিং লুপ চালিয়ে ফ্রিকোয়েন্সি গণনায় O(N) লিনিয়ার সময় লাগে।",
    ),
    QuizQuestion(
      questionEn: "2. If the strings contain ASCII lowercase characters only ('a' through 'z'), what is the Space Complexity of using an integer array `count[26]`?",
      questionBn: "২. স্ট্রিংয়ে কেবল ছোট হাতের বর্ণ ('a' থেকে 'z') থাকলে `count[26]` অ্যারে ব্যবহারের স্পেস জটিলতা কত?",
      optionsEn: ["A) O(1) constant auxiliary space!", "B) O(N) space", "C) O(N^2)", "D) O(log N)"],
      optionsBn: ["A) O(1) কনস্ট্যান্ট অতিরিক্ত মেমোরি!", "B) O(N) স্পেস", "C) O(N^2)", "D) O(log N)"],
      correctOptionIndex: 0,
      explanationEn: "Correct! The array size is fixed at 26 elements regardless of string length N, making space complexity O(1).",
      explanationBn: "সঠিক! স্ট্রিং দৈর্ঘ্য N যতই বড় হোক, মেমোরি সাইজ ২৬ এ ফিক্সড থাকে, যা O(1) কনস্ট্যান্ট স্পেস।",
    ),
  ];
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            widget.isEnglish ? "Valid Anagram Quiz" : "এনগ্রাম টেস্ট কুইজ",
                            overflow: TextOverflow.ellipsis,
                            maxLines: 1,
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      widget.isEnglish ? "Valid Anagram Test Runner" : "এনগ্রাম টেস্ট রানার",
              ...
              Text(
                widget.isEnglish
                    ? "Verify character frequency match logic across valid and invalid anagram string pairs."
                    : "এনগ্রাম ফ্রিকোয়েন্সি লজিক বিভিন্ন স্ট্রিং জোড়ায় ভেরিফাই করুন।",
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.isEnglish ? "Valid Anagram Mastery Quiz" : "এনগ্রাম মাস্টার কুইজ",
