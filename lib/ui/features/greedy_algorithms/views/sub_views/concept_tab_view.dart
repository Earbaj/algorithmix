...
class GreedyConceptTabView extends StatelessWidget {
  final Map<String, String> intro;
  final bool isEnglish;

  const GreedyConceptTabView({
    super.key,
    required this.intro,
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildCodeBox("Template 1: Jump Game (LeetCode 55)", """
bool canJump(vector<int>& nums) {
    ...
    return true;
            ...
            _buildCodeBox("Template 2: Non-overlapping Intervals (LeetCode 435)", """
int eraseOverlapIntervals(vector<vector<int>>& intervals) {
    ...
    return count;
            ...
            const SizedBox(height: 16),
            _buildCodeBox("Template 3: Gas Station (LeetCode 134)", """
