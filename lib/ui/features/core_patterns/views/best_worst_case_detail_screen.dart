...
class BestWorstCaseDetailScreen extends StatefulWidget {
  ...
  @override
  State<BestWorstCaseDetailScreen> createState() =>
      _BestWorstCaseDetailScreenState();
}

class _BestWorstCaseDetailScreenState extends State<BestWorstCaseDetailScreen>
                ...
                children: [
                  Text(
                    _isEnglish
                        ...
                        : 'বেস্ট বনাম এভারেজ বনাম ওয়ার্স্ট কেস অ্যানালাইসিস',
                    style: TextStyle(
                  ...
                  Text(
                    _isEnglish
                        ? 'Evaluating how algorithm performance varies based on input data arrangement.\n• Best Case: Optimal arrangement (e.g. target at index 0).\n• Average Case: Expected typical case.\n• Worst Case: Maximum possible steps (e.g. bad pivot in Quick Sort).'
                        : 'ইনপুট ডাটা সাজানোর ওপর ভিত্তি করে পারফরম্যান্স তারতম্য বিশ্লেষণ।\n• বেস্ট কেস: সেরা বিন্যাস (যেমন টার্গেট ইনডেক্স ০ তে থাকা)।\n• এভারেজ কেস: প্রত্যাশিত সাধারণ কেস।\n• ওয়ার্স্ট কেস: সর্বোচ্চ ধাপ (যেমন কুইক সর্টে খারাপ পিবট)।',
                    style: TextStyle(
  ...
  Widget _buildVisualizerTab(double hPadding) {
    return ResponsiveCenter(
      maxWidth: 1280.0,
      padding: EdgeInsets.all(hPadding),
      child: BestWorstCaseCodeFreeVisualizer(isEnglish: _isEnglish),
    );
  }

  Widget _buildCodeTraceTab(double hPadding) {
    String code = """
// Linear Search Cases Trace
int search(vector<int>& arr, int target) {
    for (int i = 0; i < arr.size(); i++) {
        if (arr[i] == target) return i; // Best: O(1) at idx 0, Worst: O(N) at end
    }
    return -1;
}""";
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    _isEnglish
                        ? "🧠 Interactive Quiz: Worst Case Analysis"
                        : "🧠 ইন্টারেক্টিভ কুইজ: ওয়ার্স্ট কেস অ্যানালাইসিস",
                    style: TextStyle(
                        fontSize: Responsive.sp(context, 16),
                        fontWeight: FontWeight.bold,
                        color: Colors.white),
                  ...
                  Text(
                    _isEnglish
                        ? "What is the worst-case time complexity of Quick Sort with a bad pivot choice on a sorted array?"
                        : "সর্ট করা অ্যারেতে খারাপ পিবট সিলেক্ট করলে কুইক সর্টের ওয়ার্স্ট-কেস টাইম কমপ্লেক্সিটি কত হয়?",
                    style: TextStyle(
                        fontSize: Responsive.sp(context, 13.5),
                        color: AppTheme.textSecondary),
                  ),
                  ...
                  ...List.generate(4, (idx) {
                    final options = ["O(N log N)", "O(N^2)", "O(N)", "O(1)"];
                  ...
                  if (!_quizSubmitted)
                    ...
                    Container(
                      ...
                      child: Text(
                        _isEnglish
                            ? "💡 Bad pivots cause unbalanced partitions leading to O(N^2)."
                            : "💡 খারাপ পিবটের কারণে আনব্যালেন্সড পার্টিশন হয়ে O(N^2) হয়।",
