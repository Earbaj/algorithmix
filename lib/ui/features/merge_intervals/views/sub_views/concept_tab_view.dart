...
class MergeIntervalsConceptTabView extends StatelessWidget {
  final Map<String, String> intro;
  final bool isEnglish;

  const MergeIntervalsConceptTabView({
    super.key,
    required this.intro,
...
vector<vector<int>> insert(vector<vector<int>>& intervals, vector<int>& newInterval) {
    ...
    return res;
            ...
            const SizedBox(height: 16),
            _buildCodeBox("Template 3: Interval List Intersections (LeetCode 986)", """
