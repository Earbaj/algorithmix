...
import 'dsu_components_visualizer.dart';

class StonesRemovedVisualizer extends StatefulWidget {
  final bool isEnglish;

  const StonesRemovedVisualizer({super.key, required this.isEnglish});

  @override
  State<StonesRemovedVisualizer> createState() => _StonesRemovedVisualizerState();
}

class _StonesRemovedVisualizerState extends State<StonesRemovedVisualizer> {
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              const Text("Stones Removed DSU Result", style: TextStyle(color: AppTheme.accentNeonCyan, fontWeight: FontWeight.bold, fontSize: 13)),
              Text("Removed: [5]", style: const TextStyle(color: AppTheme.accentGreen, fontWeight: FontWeight.bold, fontSize: 12)),
            ],
          ),
          const SizedBox(height: 16),
          Container(
            ...
            child: Column(
              children: [
                const Text("Maximum Removed Stones Count:", style: TextStyle(color: AppTheme.textSecondary, fontSize: 12)),
                const SizedBox(height: 8),
                Text("5 Stones", style: const TextStyle(color: AppTheme.accentGreen, fontWeight: FontWeight.bold, fontSize: 22)),
              ],
            ),
          ),
        ],
