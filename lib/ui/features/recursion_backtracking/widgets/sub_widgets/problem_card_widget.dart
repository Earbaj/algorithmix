...
class RecursionBacktrackingProblemCardWidget extends StatelessWidget {
  final RecursionBacktrackingProblem problem;
  final Color diffColor;
  final bool isEnglish;

  const RecursionBacktrackingProblemCardWidget({
    super.key,
