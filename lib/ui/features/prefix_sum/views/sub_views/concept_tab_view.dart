...
class PrefixConceptTabView extends StatelessWidget {
  final Map<String, String> intro;
  final bool isEnglish;

  const PrefixConceptTabView({
    super.key,
    required this.intro,
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildCodeBox("Template 1: Subarray Sum Equals K (Prefix Sum + HashMap)", """
int subarraySum(vector<int>& nums, int k) {
    ...
    return count;
            ...
            _buildCodeBox("Template 2: Range Sum Query Immutable (1D Array)", """
class NumArray {
    vector<int> prefix;
public:
    ...
    int sumRange(int left, int right) {
        return prefix[right + 1] - prefix[left]; // O(1) Range Query!
            ...
            const SizedBox(height: 16),
            _buildCodeBox("Template 3: Product of Array Except Self (O(1) Space)", """
