        ...
        child: Column(
          ...
          children: [
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(isEnglish ? 'Two-Pass vs One-Pass Fast & Slow' : 'দুই পাস বনাম এক পাস Fast & Slow',
                    style: TextStyle(fontSize: Responsive.sp(context, 16), fontWeight: FontWeight.bold, color: Colors.white)),
                const SizedBox(height: 12),
