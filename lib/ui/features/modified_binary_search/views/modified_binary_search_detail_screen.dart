...
class _ModifiedBinarySearchDetailScreenState extends State<ModifiedBinarySearchDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(_isEnglish ? 'Modified Binary Search Deep Dive' : 'Modified Binary Search গাইড'),
        centerTitle: true,
        actions: [
          Padding(
      ...
      body: TabBarView(
        controller: _tabController,
        children: [
          ModifiedBinarySearchConceptTabView(intro: intro, isEnglish: _isEnglish),
          ModifiedBinarySearchVisualizerTabView(isEnglish: _isEnglish),
          ModifiedBinarySearchProblemsTabView(isEnglish: _isEnglish),
          ModifiedBinarySearchMistakesTabView(isEnglish: _isEnglish),
        ],
      ),
    );
  }
