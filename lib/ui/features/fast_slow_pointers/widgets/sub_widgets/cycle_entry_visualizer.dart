...
class CycleEntryVisualizer extends StatefulWidget {
  final bool isEnglish;

  const CycleEntryVisualizer({super.key, required this.isEnglish});

  @override
  State<CycleEntryVisualizer> createState() => _CycleEntryVisualizerState();
}

class _CycleEntryVisualizerState extends State<CycleEntryVisualizer> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          const Text("Linked List Nodes & Cycle Entry Tracker:", style: TextStyle(color: AppTheme.textSecondary, fontSize: 12)),
                    ...
                    AnimatedContainer(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            isBoth ? "ENTRY!" : (isSlow ? "SLOW" : (isFast ? "FAST" : "[$i]")),
