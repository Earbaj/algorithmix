...
class TwoHeapsConceptTabView extends StatelessWidget {
  final Map<String, String> intro;
  final bool isEnglish;

  const TwoHeapsConceptTabView({
    super.key,
    required this.intro,
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildCodeBox("Template 1: Find Median from Data Stream (LeetCode 295)", """
class MedianFinder {
...
public:
    ...
    double findMedian() {
        ...
        return (maxHeap.top() + minHeap.top()) / 2.0; // O(1) Query!
            ...
            _buildCodeBox("Template 2: IPO / Maximize Capital Pattern (LeetCode 502)", """
