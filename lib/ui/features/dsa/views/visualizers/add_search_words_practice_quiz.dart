...
class AddSearchWordsPracticeQuiz extends StatefulWidget {
  final bool isEnglish;

  const AddSearchWordsPracticeQuiz({
    super.key,
    required this.isEnglish,
  });

  @override
  State<AddSearchWordsPracticeQuiz> createState() =>
      _AddSearchWordsPracticeQuizState();
}
...
class _AddSearchWordsPracticeQuizState
    extends State<AddSearchWordsPracticeQuiz> {
  int _activeSubTab = 0;
  ...
  final List<TestCaseData> _testCases = const [
    TestCaseData(inputStr: "addWord(\"bad\"), addWord(\"dad\"), addWord(\"mad\"), search(\".ad\")", expectedOutputStr: "true"),
    TestCaseData(inputStr: "search(\"b..\")", expectedOutputStr: "true"),
    TestCaseData(inputStr: "search(\"pad\")", expectedOutputStr: "false"),
  ];
  ...
  final List<QuizQuestion> _quizQuestions = const [
    QuizQuestion(
      questionEn: "1. How does the Trie search handle the dot '.' wildcard in Design Add & Search Words?",
      questionBn: "১. Design Add & Search Words সমস্যায় ডট '.' ওয়াইল্ডকার্ড ট্রাই সার্চে কীভাবে কাজ করে?",
      optionsEn: [
        "A) Uses recursive DFS backtracking to inspect ALL 26 possible non-null child branch nodes at that index!",
        "B) Skips the index completely",
        "C) Converts the string to Regex",
        "D) Throws an exception"
      ],
      optionsBn: [
        "A) রিকার্সিভ DFS ব্যাকট্র্যাকিং দিয়ে ২৬টি চাইল্ড নোডের যেগুলো নাল নয় সেগুলোর প্রতিটি রিকার্সিভলি সার্চ করে!",
        "B) ইনডেক্স পুরোপুরি স্কিপ করে",
        "C) স্ট্রিংকে Regex এ রূপান্তর করে",
        "D) এক্সেপশন থ্রো করে"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! The dot '.' character acts as a wildcard, forcing DFS to explore every active child branch.",
      explanationBn: "সঠিক! ডট '.' পাওয়ার সাথে সাথে DFS সেই পজিশনের চাইল্ড নোডগুলোতে রিকার্সিভলি ব্রাঞ্চ আউট করে।",
    ),
    QuizQuestion(
      questionEn: "2. What is the worst-case time complexity of searching a word with all dot wildcards (e.g. '...') in a Trie?",
      questionBn: "২. ট্রাইতে সব কয়টি ক্যারেক্টার ডট (যেমন '...') দেওয়া থাকলে ওয়ার্স্ট কেস টাইম ক্যাটলগ জটিলতা কত?",
      optionsEn: [
        "A) O(26^L) - Where L is the word length",
        "B) O(L)",
        "C) O(N)",
        "D) O(1)"
      ],
      optionsBn: [
        "A) O(26^L) - যেখানে L হলো শব্দের দৈর্ঘ্য",
        "B) O(L)",
        "C) O(N)",
        "D) O(1)"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! If every character is '.', the search branches into 26 possible children at each of the L steps, giving O(26^L).",
      explanationBn: "সঠিক! প্রতিটি ক্যারেক্টার ডট হলে L টি স্টেপে সর্বোচ্চ ২৬ গুণ রিকার্সন ঘটে (O(26^L))।",
    ),
  ];
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            widget.isEnglish ? "Wildcard Trie Quiz" : "ওয়াইল্ডকার্ড ট্রাই কুইজ",
                            overflow: TextOverflow.ellipsis,
                            maxLines: 1,
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      widget.isEnglish ? "Wildcard Search Test Runner" : "ওয়াইল্ডকার্ড সার্চ টেস্ট রানার",
              ...
              Text(
                widget.isEnglish
                    ? "Verify dot '.' wildcard DFS backtracking search logic in Trie."
                    : "ট্রাইতে ডট '.' ওয়াইল্ডকার্ড DFS ব্যাকট্র্যাকিং লজিক টেস্ট করুন।",
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.isEnglish ? "Wildcard Trie Mastery Quiz" : "ওয়াইল্ডকার্ড মাস্টার কুইজ",
