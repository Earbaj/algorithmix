...
class KWayMergeConceptTabView extends StatelessWidget {
  final Map<String, String> intro;
  final bool isEnglish;

  const KWayMergeConceptTabView({
    super.key,
    required this.intro,
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildCodeBox("Template 1: Merge K Sorted Lists (LeetCode 23)", """
...
ListNode* mergeKLists(vector<ListNode*>& lists) {
    ...
    return dummy.next;
            ...
            _buildCodeBox("Template 2: Kth Smallest Element in Matrix (LeetCode 378)", """
int kthSmallest(vector<vector<int>>& matrix, int k) {
    ...
    return get<0>(minHeap.top());
            ...
            const SizedBox(height: 16),
            _buildCodeBox("Template 3: Smallest Range Covering K Lists (LeetCode 632)", """
