...
class DetectCycleGraphPracticeQuiz extends StatefulWidget {
  final bool isEnglish;

  const DetectCycleGraphPracticeQuiz({
    super.key,
    required this.isEnglish,
  });

  @override
  State<DetectCycleGraphPracticeQuiz> createState() =>
      _DetectCycleGraphPracticeQuizState();
}
...
class _DetectCycleGraphPracticeQuizState
    extends State<DetectCycleGraphPracticeQuiz> {
  int _activeSubTab = 0;
  ...
  final List<TestCaseData> _testCases = const [
    TestCaseData(inputStr: "V = 4, adj = [[1, 2], [0, 2], [0, 1, 3], [2]]", expectedOutputStr: "true (Cycle detected: 0-1-2-0)"),
    TestCaseData(inputStr: "V = 3, adj = [[1], [0, 2], [1]]", expectedOutputStr: "false (Linear tree line, no cycle)"),
    TestCaseData(inputStr: "V = 1, adj = [[]]", expectedOutputStr: "false"),
  ];
  ...
  final List<QuizQuestion> _quizQuestions = const [
    QuizQuestion(
      questionEn: "1. Why must we check `v != parent` when detecting cycles in an UNDIRECTED graph?",
      questionBn: "১. আনডিরেক্টেড গ্রাফে সাইকেল সনাক্ত করার সময় কেন আমাদের `v != parent` কন্ডিশন চেক করতে হয়?",
      optionsEn: [
        "A) Because undirected edges go both ways (u <-> v), so returning back to immediate parent vertex is NOT a cycle!",
        "B) Because parents have 0 degree",
        "C) To convert undirected graph to DAG",
        "D) It is optional"
      ],
      optionsBn: [
        "A) কারণ আনডিরেক্টেড গ্রাফে এজ উভয় দিকে থাকে (u <-> v), তাই অবিলম্বে প্যারেন্ট ভার্টেক্সে ফেরত আসা সাইকেল নয়!",
        "B) কারণ প্যারেন্টের ডিগ্রি ০",
        "C) আনডিরেক্টেড গ্রাফকে DAG এ রূপান্তর করতে",
        "D) এটি ঐচ্ছিক"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! Edge u-v implies v-u. Returning to node u's parent node is trivial traversal, not a back-edge cycle.",
      explanationBn: "সঠিক! এজ u-v দিয়ে গেলে অবিলম্বে v-u ব্যাক করা স্বাভাবিক ট্রাভার্সাল, সাইকেল নয়।",
    ),
    QuizQuestion(
      questionEn: "2. What algorithm or data structure can detect cycles in an undirected graph in O(V + E) time?",
      questionBn: "২. আনডিরেক্টেড গ্রাফে O(V + E) সময়ে সাইকেল সনাক্ত করতে কোন অ্যালগরিদম ব্যবহার করা যায়?",
      optionsEn: [
        "A) DFS / BFS with parent tracking OR Disjoint Set Union (DSU)",
        "B) Dijkstra Algorithm",
        "C) Prim's MST",
        "D) Floyd Warshall"
      ],
      optionsBn: [
        "A) প্যারেন্ট ট্র্যাকিং সহ DFS / BFS অথবা Disjoint Set Union (DSU)",
        "B) ডাইকস্ট্রা অ্যালগরিদম",
        "C) প্রিমসের MST",
        "D) ফ্লয়েড ওয়ারশাল"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! DFS/BFS with parent tracking or DSU (Disjoint Set Union) can identify graph cycles in linear time.",
      explanationBn: "সঠিক! প্যারেন্ট ট্র্যাকিং সহ DFS/BFS অথবা DSU দিয়ে খুব সহজেই গ্রাফ সাইকেল বের করা যায়।",
    ),
  ];
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            widget.isEnglish ? "Detect Cycle Quiz" : "সাইকেল ডিটেক্ট কুইজ",
                            overflow: TextOverflow.ellipsis,
                            maxLines: 1,
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      widget.isEnglish ? "Detect Cycle Test Runner" : "সাইকেল ডিটেক্ট টেস্ট রানার",
              ...
              Text(
                widget.isEnglish
                    ? "Verify cycle detection in undirected graph adjacency lists using parent tracking."
                    : "প্যারেন্ট ট্র্যাকিং সহ আনডিরেক্টেড গ্রাফের সাইকেল সনাক্তকরণ টেস্ট করুন।",
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.isEnglish ? "Detect Cycle Mastery Quiz" : "সাইকেল ডিটেক্ট কুইজ",
