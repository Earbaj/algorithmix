...
class TreeBfsConceptTabView extends StatelessWidget {
  final Map<String, String> intro;
  final bool isEnglish;

  const TreeBfsConceptTabView({
    super.key,
    required this.intro,
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildCodeBox("Template 1: Standard Level Order Traversal (LeetCode 102)", """
vector<vector<int>> levelOrder(TreeNode* root) {
    ...
    return res;
            ...
            _buildCodeBox("Template 2: Zigzag Level Order Traversal (LeetCode 103)", """
vector<vector<int>> zigzagLevelOrder(TreeNode* root) {
    ...
    return res;
            ...
            const SizedBox(height: 16),
            _buildCodeBox("Template 3: Binary Tree Right Side View (LeetCode 199)", """
vector<int> rightSideView(TreeNode* root) {
    ...
    while (!q.empty()) {
        ...
        for (int i = 0; i < size; i++) {
            TreeNode* curr = q.front(); q.pop();
            if (i == size - 1) res.push_back(curr->val); // Rightmost node
            if (curr->left) q.push(curr->left);
            if (curr->right) q.push(curr->right);
        }
    }
