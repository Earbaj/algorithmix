...
class _MonotonicStackDetailScreenState extends State<MonotonicStackDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(_isEnglish ? 'Monotonic Stack Deep Dive' : 'Monotonic Stack গাইড'),
        centerTitle: true,
        actions: [
          Padding(
      ...
      body: TabBarView(
        controller: _tabController,
        children: [
          MonotonicConceptTabView(intro: intro, isEnglish: _isEnglish),
          MonotonicVisualizerTabView(isEnglish: _isEnglish),
          MonotonicProblemsTabView(isEnglish: _isEnglish),
          MonotonicMistakesTabView(isEnglish: _isEnglish),
        ],
      ),
    );
  }
