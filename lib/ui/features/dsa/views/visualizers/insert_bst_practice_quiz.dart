...
class InsertBstPracticeQuiz extends StatefulWidget {
  final bool isEnglish;

  const InsertBstPracticeQuiz({
    super.key,
    required this.isEnglish,
  });

  @override
  State<InsertBstPracticeQuiz> createState() => _InsertBstPracticeQuizState();
}
...
class _InsertBstPracticeQuizState extends State<InsertBstPracticeQuiz> {
  int _activeSubTab = 0;
  ...
  final List<TestCaseData> _testCases = const [
    TestCaseData(inputStr: "root = [4,2,7,1,3], val = 5", expectedOutputStr: "root = [4, 2, 7, 1, 3, 5]"),
    TestCaseData(inputStr: "root = [40,20,60,10,30,50,70], val = 25", expectedOutputStr: "root = [40, 20, 60, 10, 30, 50, 70, null, null, 25]"),
    TestCaseData(inputStr: "root = [], val = 5", expectedOutputStr: "root = [5]"),
  ];
  ...
  final List<QuizQuestion> _quizQuestions = const [
    QuizQuestion(
      questionEn: "1. Where is a new key ALWAYS inserted in a Binary Search Tree?",
      questionBn: "১. একটি নতুন মান BST তে সর্বদা কোথায় ইনসার্ট বা যুক্ত করা হয়?",
      optionsEn: [
        "A) As a new LEAF node replacing a `nullptr` location!",
        "B) As the new Root node always",
        "C) In the middle level always",
        "D) Replacing an existing duplicate node"
      ],
      optionsBn: [
        "A) একটি খালি `nullptr` স্থানে নতুন লিফ নোড (Leaf Node) হিসেবে!",
        "B) সর্বদা নতুন রুট নোড হিসেবে",
        "C) মাঝখানের লেভেলে",
        "D) বিদ্যমান ডুপ্লিকেট নোড রিপ্লেস করে"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! Standard BST insertion traverses down to a leaf position where it replaces `nullptr` with a new node.",
      explanationBn: "সঠিক! BST ট্রাভার্সাল করে নাল পজিশনে নতুন লিফ নোড যুক্ত করে।",
    ),
    QuizQuestion(
      questionEn: "2. Does inserting into a BST require shifting existing nodes like an array?",
      questionBn: "২. BST তে ইনসার্ট করলে কি অ্যারের মতো অন্যান্য নোডগুলোকে মেমোরিতে শিফট করতে হয়?",
      optionsEn: [
        "A) NO! Node pointers are dynamically linked in O(1) time once the position is found!",
        "B) Yes, all right subtrees must shift",
        "C) Yes, array elements re-index",
        "D) Only left children shift"
      ],
      optionsBn: [
        "A) না! পজিশন পাওয়ার পর কেবল ডাইনামিক পয়েন্টার লিঙ্কযুক্ত হয় (O(1))!",
        "B) হ্যাঁ, ডান সাবট্রির নোড শিফট হয়",
        "C) হ্যাঁ, অ্যারে ইনডেক্স রিভার্স হয়",
        "D) কেবল বাম নোড শিফট হয়"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! Unlike arrays that require O(N) element shifting, linked tree nodes only require updating a parent child pointer.",
      explanationBn: "সঠিক! অ্যারের মতো নোড শিফটিং লাগে না, পয়েন্টার আপডেট করেই O(1) এ লিঙ্ক করা সম্ভব।",
    ),
  ];
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            widget.isEnglish ? "Insert BST Quiz" : "ইনসার্ট BST কুইজ",
                            overflow: TextOverflow.ellipsis,
                            maxLines: 1,
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      widget.isEnglish ? "Insert into BST Test Runner" : "ইনসার্ট BST টেস্ট রানার",
              ...
              Text(
                widget.isEnglish
                    ? "Verify node insertion logic into empty and existing binary search trees."
                    : "ফাঁকা ও বিদ্যমান ট্রিতে নোড ইনসার্ট লজিক ভেরিফাই করুন।",
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.isEnglish ? "Insert BST Mastery Quiz" : "ইনসার্ট BST মাস্টার কুইজ",
