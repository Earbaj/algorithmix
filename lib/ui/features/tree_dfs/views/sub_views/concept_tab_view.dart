...
class TreeDfsConceptTabView extends StatelessWidget {
  final Map<String, String> intro;
  final bool isEnglish;

  const TreeDfsConceptTabView({
    super.key,
    required this.intro,
...
void preorder(TreeNode* root, vector<int>& res) {
    ...
    preorder(root->right, res); // 3. Visit Right Subtree
            ...
            _buildCodeBox("Template 2: Inorder Traversal (Left -> Root -> Right - LeetCode 94)", """
void inorder(TreeNode* root, vector<int>& res) {
    ...
    inorder(root->right, res); // 3. Visit Right Subtree
            ...
            const SizedBox(height: 16),
            _buildCodeBox("Template 3: Path Sum DFS (LeetCode 112)", """
