...
class MonotonicConceptTabView extends StatelessWidget {
  final Map<String, String> intro;
  final bool isEnglish;

  const MonotonicConceptTabView({
    super.key,
    required this.intro,
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            // 3 Main Monotonic Stack Patterns
            Text(
              intro["typesTitle"]!,
              style: TextStyle(
            ...
            const SizedBox(height: 12),
            _buildCodeBox("Template 1: Daily Temperatures (Monotonic Decreasing Stack)", """
vector<int> dailyTemperatures(vector<int>& temp) {
    ...
    return ans;
            ...
            _buildCodeBox("Template 2: Next Greater Element I (HashMap + Stack)", """
vector<int> nextGreaterElement(vector<int>& nums1, vector<int>& nums2) {
    ...
    return ans;
            ...
            const SizedBox(height: 16),
            _buildCodeBox("Template 3: Largest Rectangle in Histogram (Monotonic Increasing Stack)", """
