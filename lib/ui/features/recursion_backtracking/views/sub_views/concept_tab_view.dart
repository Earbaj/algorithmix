...
class RecursionConceptTabView extends StatelessWidget {
  final Map<String, String> intro;
  final bool isEnglish;

  const RecursionConceptTabView({
    super.key,
    required this.intro,
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildCodeBox("Template 1: Subsets (Take / Skip Pattern)", """
...
void permute(vector<int>& nums, int start) {
    ...
    for (int i = start; i < nums.size(); i++) {
        ...
        swap(nums[start], nums[i]); // Backtrack
            ...
            const SizedBox(height: 16),
            _buildCodeBox("Template 3: Grid / Constraint Backtracking (Choose-Recurse-Unchoose)", """
