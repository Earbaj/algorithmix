...
class DfsGraphPracticeQuiz extends StatefulWidget {
  final bool isEnglish;

  const DfsGraphPracticeQuiz({
    super.key,
    required this.isEnglish,
  });

  @override
  State<DfsGraphPracticeQuiz> createState() => _DfsGraphPracticeQuizState();
}
...
class _DfsGraphPracticeQuizState extends State<DfsGraphPracticeQuiz> {
  int _activeSubTab = 0;
  ...
  final List<TestCaseData> _testCases = const [
    TestCaseData(inputStr: "V = 5, adj = [[1, 2], [0, 3], [0, 4], [1], [2]]", expectedOutputStr: "[0, 1, 3, 2, 4]"),
    TestCaseData(inputStr: "V = 4, adj = [[1, 2], [0], [0, 3], [2]]", expectedOutputStr: "[0, 1, 2, 3]"),
    TestCaseData(inputStr: "V = 1, adj = [[]]", expectedOutputStr: "[0]"),
  ];
  ...
  final List<QuizQuestion> _quizQuestions = const [
    QuizQuestion(
      questionEn: "1. What underlying data structure manages backtracking during Depth-First Search (DFS)?",
      questionBn: "১. Depth-First Search (DFS) এ ব্যাকট্র্যাকিং মেকানিজম কোন ডেটা স্ট্রাকচার নিয়ন্ত্রণ করে?",
      optionsEn: [
        "A) The Recursive Call Stack (or explicit Stack) LIFO behavior!",
        "B) FIFO Queue",
        "C) Priority Min-Heap",
        "D) Hash Set"
      ],
      optionsBn: [
        "A) রিকার্সিভ কল স্ট্যাক (Call Stack) এর LIFO বৈশিষ্ট্য!",
        "B) FIFO কিউ",
        "C) প্রাইওরিটি Min-Heap",
        "D) হ্যাশ সেট"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! DFS uses function recursion stack frames or an explicit LIFO Stack to go deep and backtrack.",
      explanationBn: "সঠিক! DFS রিকার্সিভ ফাংশন কল স্ট্যাকের LIFO বৈশিষ্ট্য ব্যবহার করে গভীরে অনুসন্ধানের পর পূর্ববর্তী নোডে ব্যাকট্র্যাক করে।",
    ),
    QuizQuestion(
      questionEn: "2. In a disconnected graph with multiple components, how do we ensure all vertices are visited using DFS?",
      questionBn: "২. ডিসকানেক্টেড গ্রাফের ক্ষেত্রে সব উপাদান ভিসিট করতে কীভাবে DFS চালাতে হয়?",
      optionsEn: [
        "A) Run a `for(i = 0 to V-1)` loop and invoke DFS whenever `visited[i]` is false!",
        "B) Run DFS once from node 0 only",
        "C) Double the edge count",
        "D) Convert graph to binary tree"
      ],
      optionsBn: [
        "A) `for(i = 0 to V-1)` লুপ চালিয়ে যেকোনো `visited[i]` মিথ্যে পেলে নতুন করে DFS রান করা!",
        "B) কেবল নোড 0 থেকে একবার DFS চালানো",
        "C) এজের সংখ্যা দ্বিগুণ করা",
        "D) গ্রাফকে বাইনারি ট্রিতে রূপান্তর করা"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! An outer loop iterating all vertices handles disconnected components effectively.",
      explanationBn: "সঠিক! আউটার লুপ সমস্ত ভার্টেক্স ঘুরলে বিচ্ছিন্ন সকল সাব-গ্রাফ ভিসিট করা সম্ভব হয়।",
    ),
  ];
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            widget.isEnglish ? "DFS Graph Quiz" : "DFS গ্রাফ কুইজ",
                            overflow: TextOverflow.ellipsis,
                            maxLines: 1,
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      widget.isEnglish ? "DFS Traversal Test Runner" : "DFS ট্রাভার্সাল টেস্ট রানার",
              ...
              Text(
                widget.isEnglish
                    ? "Verify recursive depth-first search traversal logic for undirected graph adjacency lists."
                    : "অ্যাডজাসেন্সি লিস্ট গ্রাফের ক্ষেত্রে রিকার্সিভ DFS ট্রাভার্সাল টেস্ট করুন।",
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.isEnglish ? "DFS Graph Mastery Quiz" : "DFS গ্রাফ মাস্টার কুইজ",
