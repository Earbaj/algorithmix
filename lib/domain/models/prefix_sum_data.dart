...
class PrefixSumData {
  ...
  static List<PrefixSumProblem> getHardProblems() {
    return const [
      ...
      PrefixSumProblem(
        ...
        keyIdeaEn: "Prefix sum array + Merge Sort counting pairs in range [lower, upper] or Segment Tree.",
        keyIdeaBn: "প্রিফিক্স সামের ওপর মার্জ সর্ট বা সেগমেন্ট ট্রি দিয়ে রেঞ্জ সাম কাউন্ট করুন।",
        isPopular: true,
      ),
      PrefixSumProblem(
        ...
        difficulty: "Hard",
        companyTags: ["Google", "Amazon", "Meta", "Microsoft"],
        keyIdeaEn: "2D Prefix Sum column reduction + 1D Subarray Sum Equals Target HashMap in O(R^2 * C) time.",
        keyIdeaBn: "২ কলাম ফিক্সড রেখে ১D Subarray Sum Equals Target হ্যাশম্যাপ চালান।",
      ),
    ];
  }
  ...
  static List<Map<String, String>> getCommonMistakes(bool isEnglish) {
    if (isEnglish) {
      return [
        {
          "title": "1. Forgetting to Initialize `prefixMap[0] = 1`",
          "desc": "In Subarray Sum Equals K, failing to set `map[0] = 1` misses subarrays starting at index 0 whose cumulative sum is exactly K!"
        },
        {
          "title": "2. Off-by-One Errors in Range Sum Formula",
          "desc": "Using `prefix[R] - prefix[L]` instead of `prefix[R+1] - prefix[L]` (when using 1-indexed prefix array) undercounts the element at index R or includes element at index L-1."
        },
        {
          "title": "3. Negative Remainder Modulo Pitfall in `Subarray Sums Divisible by K`",
          "desc": "In C++, `currSum % k` can return negative values for negative cumulative sums. Always normalize modulo: `int rem = ((currSum % k) + k) % k;`."
        },
        {
          "title": "4. Modifying Input Array in Product Except Self Without Prefix/Suffix Logic",
          "desc": "Accidentally overwriting elements before computing suffix product."
        },
        {
          "title": "5. Overlapping Inclusion-Exclusion Miscalculation in 2D Prefix Sum",
          "desc": "Forgetting to add back top-left corner `+ P[r1-1][c1-1]` in 2D grid range sum formula."
        },
      ];
    } else {
      return [
        {
          "title": "১. হ্যাশম্যাপে `prefixMap[0] = 1` ইনিশিয়ালাইজ করতে ভুলে যাওয়া",
          "desc": "Subarray Sum Equals K প্রবলেমে `map[0] = 1` না দিলে ইনডেক্স ০ থেকে শুরু হওয়া সাবএরেগুলো গণনায় মিস হয়ে যাবে!"
        },
        {
          "title": "২. রেঞ্জ সাম সূত্রে অফ-বাই-ওয়ান ভুল করা",
          "desc": "`prefix[R+1] - prefix[L]` এর বদলে `prefix[R] - prefix[L]` লিখলে ইনডেক্স R এর উপাদান বাদ পড়ে যাবে।"
        },
        {
          "title": "৩. ঋনাত্বক সংখ্যায় ভাগশেষ মোডুলো ভুল (`Subarray Sums Divisible by K`)",
          "desc": "C++ এ ঋনাত্বক সংখ্যার মোডুলো নেগেটিভ মান দেখায়। সবসময় ক্যানোনিকাল মোডুলো ব্যবহার করুন: `int rem = ((currSum % k) + k) % k;`।"
        },
        {
          "title": "৪. Product Except Self এ মান ওভাররাইট করে ফেলা",
          "desc": "সাফিক্স প্রোডাক্ট গণনার আগেই অরিজিনাল ইনপুট মান ওভাররাইট করে ফেললে ভুল গুণফল আসবে।"
        },
        {
          "title": "৫. ২D ম্যাট্রিক্স রেঞ্জ সামে কর্নার ওভারল্যাপ যোগ করতে ভুলে যাওয়া",
          "desc": "২D রেঞ্জ সাম সূত্রে টপ-লেফট কর্নার `+ P[r1-1][c1-1]` পুনরায় যোগ করতে ভুলে যাওয়া।"
        },
      ];
    }
  }
