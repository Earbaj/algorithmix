...
class UnionFindConceptTabView extends StatelessWidget {
  final Map<String, String> intro;
  final bool isEnglish;

  const UnionFindConceptTabView({
    super.key,
    required this.intro,
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildCodeBox("Template 1: Standard DSU Class with Path Compression & Union by Rank", """
class DSU {
...
public:
    ...
    bool unite(int u, int v) {
        ...
        parent[rootV] = rootU; count--; return true; // Merge roots & decrement count
            ...
            _buildCodeBox("Template 2: Redundant Connection Cycle Detection (LeetCode 684)", """
vector<int> findRedundantConnection(vector<vector<int>>& edges) {
    ...
    return {};
            ...
            const SizedBox(height: 16),
            _buildCodeBox("Template 3: Most Stones Removed with Same Row or Col (LeetCode 947)", """
