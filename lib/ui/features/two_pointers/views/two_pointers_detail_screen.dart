...
class _TwoPointersDetailScreenState extends State<TwoPointersDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(_isEnglish ? 'Two Pointers Deep Dive' : 'Two Pointers গাইড'),
        centerTitle: true,
        actions: [
          Padding(
      ...
      body: TabBarView(
        controller: _tabController,
        children: [
          TwoPointersConceptTabView(intro: intro, isEnglish: _isEnglish),
          TwoPointersVisualizerTabView(isEnglish: _isEnglish),
          TwoPointersProblemsTabView(isEnglish: _isEnglish),
          TwoPointersMistakesTabView(isEnglish: _isEnglish),
        ],
      ),
    );
  }
