...
class GasStationVisualizer extends StatefulWidget {
  final bool isEnglish;

  const GasStationVisualizer({super.key, required this.isEnglish});

  @override
  State<GasStationVisualizer> createState() => _GasStationVisualizerState();
}

class _GasStationVisualizerState extends State<GasStationVisualizer> {
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              const Text("Gas Station Circular Trip", style: TextStyle(color: AppTheme.accentNeonCyan, fontWeight: FontWeight.bold, fontSize: 13)),
              Text("Start Station: [${step.stateVal}]", style: const TextStyle(color: AppTheme.accentGreen, fontWeight: FontWeight.bold, fontSize: 12)),
            ],
          ),
          const SizedBox(height: 16),
          Container(
            ...
            child: Column(
              children: [
                const Text("Optimal Starting Station Index:", style: TextStyle(color: AppTheme.textSecondary, fontSize: 12)),
                const SizedBox(height: 8),
                Text("Index ${step.stateVal}", style: const TextStyle(color: AppTheme.accentGreen, fontWeight: FontWeight.bold, fontSize: 18)),
              ],
            ),
          ),
        ],
