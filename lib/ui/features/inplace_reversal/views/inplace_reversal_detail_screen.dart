...
class _InplaceReversalDetailScreenState extends State<InplaceReversalDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(_isEnglish ? 'In-place Reversal Deep Dive' : 'ইন-প্লেস রিভার্সাল গাইড'),
        centerTitle: true,
        actions: [
          Padding(
      ...
      body: TabBarView(
        controller: _tabController,
        children: [
          InplaceReversalConceptTabView(intro: intro, isEnglish: _isEnglish),
          InplaceReversalVisualizerTabView(isEnglish: _isEnglish),
          InplaceReversalProblemsTabView(isEnglish: _isEnglish),
          InplaceReversalMistakesTabView(isEnglish: _isEnglish),
        ],
      ),
    );
  }
