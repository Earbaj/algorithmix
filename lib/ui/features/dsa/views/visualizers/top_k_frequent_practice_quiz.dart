...
class TopKFrequentPracticeQuiz extends StatefulWidget {
  final bool isEnglish;

  const TopKFrequentPracticeQuiz({
    super.key,
    required this.isEnglish,
  });

  @override
  State<TopKFrequentPracticeQuiz> createState() =>
      _TopKFrequentPracticeQuizState();
}
...
class _TopKFrequentPracticeQuizState
    extends State<TopKFrequentPracticeQuiz> {
  int _activeSubTab = 0;
  ...
  final List<TestCaseData> _testCases = const [
    TestCaseData(inputStr: "nums = [1,1,1,2,2,3], k = 2", expectedOutputStr: "[1, 2]"),
    TestCaseData(inputStr: "nums = [1], k = 1", expectedOutputStr: "[1]"),
    TestCaseData(inputStr: "nums = [4,4,4,6,6,7,7,7,7], k = 2", expectedOutputStr: "[7, 4]"),
  ];
  ...
  final List<QuizQuestion> _quizQuestions = const [
    QuizQuestion(
      questionEn: "1. What comparator ordering is required for the Min-Heap pair `(frequency, val)` in Top K Frequent?",
      questionBn: "১. Top K Frequent এ Min-Heap এর জোড়া `(frequency, val)` এর জন্য কী রূপ কম্প্যারেটর লাগবে?",
      optionsEn: [
        "A) Order by `frequency` ascending so the LEAST frequent element stays at root `[0]` and gets popped first!",
        "B) Order by `val` descending",
        "C) Random comparator",
        "D) Order by `frequency` descending"
      ],
      optionsBn: [
        "A) `frequency` ছোট থেকে বড় সাজানো যাতে সবচেয়ে কম ফ্রিকোয়েন্সির উপাদান রুটে থাকে ও সহজে পপ হতে পারে!",
        "B) `val` বড় থেকে ছোট সাজানো",
        "C) র‍্যান্ডম তুলনা",
        "D) `frequency` বড় থেকে ছোট সাজানো"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! The Min-Heap compares frequency. Ejecting smaller frequencies keeps the top K highest frequencies inside the heap.",
      explanationBn: "সঠিক! হিপ ফ্রিকোয়েন্সির ভিত্তিতে ছোট মান রিমুভ করায় শেষ পর্যন্ত সবচেয়ে বেশি বার আসা K টি মান হিপে থাকে।",
    ),
    QuizQuestion(
      questionEn: "2. Can bucket sort solve Top K Frequent Elements in O(N) linear time?",
      questionBn: "২. বাকেট সর্ট (Bucket Sort) কি O(N) লিনিয়ার সময়ে Top K Frequent সমস্যা সমাধান করতে পারে?",
      optionsEn: [
        "A) YES! By creating frequency buckets from index 1 to N, elements can be grouped in O(N) time without a heap!",
        "B) No, heaps are strictly required",
        "C) No, bucket sort takes O(N^2)",
        "D) Only for negative numbers"
      ],
      optionsBn: [
        "A) হ্যাঁ! ১ থেকে N ইনডেক্সের ফ্রিকোয়েন্সি বাকেট তৈরি করে হিপ ছাড়াই O(N) সময়ে করা যায়!",
        "B) না, হিপ ব্যবহার বাধ্যতামূলক",
        "C) না, বাকেট সর্ট O(N^2) সময় নেয়",
        "D) কেবল ঋণাত্মক সংখ্যার জন্য সম্ভব"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! Bucket sort uses array indices as frequencies, yielding a linear O(N) time solution.",
      explanationBn: "সঠিক! বাকেট সর্টে অ্যারে ইনডেক্সকে ফ্রিকোয়েন্সি হিসেবে ব্যবহার করে O(N) লিনিয়ার সময়ে সমাধান করা সম্ভব।",
    ),
  ];
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            widget.isEnglish ? "Top K Frequent Quiz" : "Top K Frequent কুইজ",
                            overflow: TextOverflow.ellipsis,
                            maxLines: 1,
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      widget.isEnglish ? "Top K Frequent Test Runner" : "Top K Frequent টেস্ট রানার",
              ...
              Text(
                widget.isEnglish
                    ? "Verify Frequency Hash Map + Min-Heap top K elements logic."
                    : "ফ্রিকোয়েন্সি হ্যাশ ম্যাপ ও Min-Heap শীর্ষ K উপাদান লজিক ভেরিফাই করুন।",
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.isEnglish ? "Top K Frequent Mastery Quiz" : "Top K Frequent মাস্টার কুইজ",
