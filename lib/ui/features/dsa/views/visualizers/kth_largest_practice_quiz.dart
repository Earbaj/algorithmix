...
class KthLargestPracticeQuiz extends StatefulWidget {
  final bool isEnglish;

  const KthLargestPracticeQuiz({
    super.key,
    required this.isEnglish,
  });

  @override
  State<KthLargestPracticeQuiz> createState() => _KthLargestPracticeQuizState();
}
...
class _KthLargestPracticeQuizState extends State<KthLargestPracticeQuiz> {
  int _activeSubTab = 0;
  ...
  final List<TestCaseData> _testCases = const [
    TestCaseData(inputStr: "nums = [3,2,1,5,6,4], k = 2", expectedOutputStr: "5"),
    TestCaseData(inputStr: "nums = [3,2,3,1,2,4,5,5,6], k = 4", expectedOutputStr: "4"),
  ...
  final List<QuizQuestion> _quizQuestions = const [
    QuizQuestion(
      questionEn: "1. Why do we use a MIN-Heap of size K to find the Kth LARGEST element in an array?",
      questionBn: "১. K-তম বৃহত্তম উপাদান বের করতে আমরা কেন সাইজ K এর MIN-Heap ব্যবহার করি?",
      optionsEn: [
        "A) Because a Min-Heap of size K automatically ejects smaller elements and keeps the top root `[0]` as the Kth largest!",
        "B) Because Min-Heaps are faster to sort than arrays",
        "C) Because Max-Heap takes O(N^2) space",
        "D) It is impossible to use Max-Heap"
      ],
      optionsBn: [
        "A) কারণ সাইজ K এর Min-Heap ছোট উপাদানগুলোকে পপ করে দেয় এবং টপ রুট `[0]` এ K-তম বৃহত্তম মান ধরে রাখে!",
        "B) কারণ Min-Heap অ্যারের চেয়ে দ্রুত সর্ট হয়",
        "C) কারণ Max-Heap ওয়ান O(N^2) স্থান নেয়",
        "D) Max-Heap ব্যবহার করা অসম্ভব"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! Keeping Min-Heap size bounded to K drops smaller numbers upon `pop()`, guaranteeing `heap[0]` is the Kth largest in O(N log K) time!",
      explanationBn: "সঠিক! হিপের সাইজ K তে সীমাবদ্ধ রাখলে ছোট মানগুলো বাদ পড়ে এবং টপে K-তম বৃহত্তম মান অবশিষ্ট থাকে।",
    ),
    QuizQuestion(
      questionEn: "2. What is the overall time complexity of finding the Kth largest element using a Min-Heap of size K?",
      questionBn: "২. সাইজ K এর Min-Heap ব্যবহার করে K-তম বৃহত্তম উপাদান বের করার টাইম জটিলতা কত?",
      optionsEn: [
        "A) O(N log K)",
        "B) O(N log N)",
        "C) O(N^2)",
      ...
      correctOptionIndex: 0,
      explanationEn: "Correct! We perform N push/pop operations on a heap of max size K, each taking O(log K) time.",
      explanationBn: "সঠিক! N টি এলিমেন্ট সাইজ K এর হিপে পুশ/পপ করলে প্রতি ধাপে O(log K) সময় লাগে।",
    ),
  ];
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            widget.isEnglish ? "Kth Largest Quiz" : "Kth Largest কুইজ",
                            overflow: TextOverflow.ellipsis,
                            maxLines: 1,
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      widget.isEnglish ? "Kth Largest Test Runner" : "Kth Largest টেস্ট রানার",
              ...
              Text(
                widget.isEnglish
                    ? "Verify Min-Heap top K tracking logic against standard array inputs."
                    : "স্ট্যান্ডার্ড অ্যারে ইনপুটের বিরুদ্ধে Min-Heap K-তম মান ফিল্টারিং টেস্ট করুন।",
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.isEnglish ? "Kth Largest Mastery Quiz" : "Kth Largest মাস্টার কুইজ",
