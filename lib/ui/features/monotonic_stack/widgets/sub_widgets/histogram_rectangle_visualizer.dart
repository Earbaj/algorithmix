...
class HistogramRectangleVisualizer extends StatefulWidget {
  final bool isEnglish;

  const HistogramRectangleVisualizer({super.key, required this.isEnglish});

  @override
  State<HistogramRectangleVisualizer> createState() => _HistogramRectangleVisualizerState();
}

class _HistogramRectangleVisualizerState extends State<HistogramRectangleVisualizer> {
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              const Text("Histogram Monotonic Stack", style: TextStyle(color: AppTheme.accentNeonCyan, fontWeight: FontWeight.bold, fontSize: 13)),
              Text("Max Area: [${step.ansArray.first}]", style: const TextStyle(color: AppTheme.accentGreen, fontWeight: FontWeight.bold, fontSize: 12)),
            ],
          ),
          const SizedBox(height: 16),
          Container(
            ...
            child: Column(
              children: [
                const Text("Calculated Largest Rectangle Area:", style: TextStyle(color: AppTheme.textSecondary, fontSize: 12)),
                const SizedBox(height: 8),
                Text("${step.ansArray.first}", style: const TextStyle(color: AppTheme.accentGreen, fontWeight: FontWeight.bold, fontSize: 22)),
              ],
            ),
          ),
        ],
