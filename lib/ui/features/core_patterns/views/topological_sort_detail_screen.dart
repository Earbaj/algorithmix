...
import 'package:algorithmix/domain/models/topological_sort_data.dart';
...
class _TopologicalSortDetailScreenState extends State<TopologicalSortDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(_isEnglish ? 'Topological Sort Deep Dive' : 'টপোলজিক্যাল সর্ট (Graph) গাইড'),
        centerTitle: true,
        actions: [
          Padding(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildCodeBox("Template 1: Course Schedule II (Topological Order C++ LeetCode 210)", """
vector<int> findOrder(int numCourses, vector<vector<int>>& prerequisites) {
    ...
    return order.size() == numCourses ? order : vector<int>();
            ...
            _buildCodeBox("Template 2: Course Schedule (Cycle Detection C++ LeetCode 207)", """
bool canFinish(int numCourses, vector<vector<int>>& prerequisites) {
    ...
    return count == numCourses; // If count < N, cycle exists!
            ...
            const SizedBox(height: 16),
            _buildCodeBox("Template 3: Alien Dictionary (Lexicographical C++ LeetCode 269)", """
string alienOrder(vector<string>& words) {
  ...
  Widget _buildVisualizerTab() {
    ...
    return ResponsiveCenter(
      padding: EdgeInsets.all(hPadding),
      child: SingleChildScrollView(
        child: TopologicalSortVisualizer(isEnglish: _isEnglish),
      ),
    );
  }
  ...
  Widget _buildProblemSection(String title, List<TopologicalSortProblem> problems, Color diffColor) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Widget _buildProblemCard(TopologicalSortProblem p, Color diffColor) {
    return Container(
  ...
  Widget _buildMistakesTab() {
    final hPadding = Responsive.horizontalPadding(context);
    final mistakes = TopologicalSortData.getCommonMistakes(_isEnglish);
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildRoadmapStep(1, _isEnglish ? "Master Graph Adjacency List & In-Degree Array" : "গ্রাফ এডজাসেন্সি লিস্ট ও ইন-ডিগ্রি অ্যারে", _isEnglish ? "Represent u -> v edges and build in-degree map." : "ডিরেক্টেড এডজের জন্য `inDegree[v]++` হিসাব করুন।"),
            _buildRoadmapStep(2, _isEnglish ? "Master Kahn's BFS In-Degree Queue Algorithm" : "Kahn's BFS ইন-ডিগ্রি ক্যু অ্যালগরিদম", _isEnglish ? "Push all in-degree 0 nodes to queue and pop in O(V + E)." : "ইন-ডিগ্রি ০ নোড দিয়ে BFS লুপ চালান।"),
            _buildRoadmapStep(3, _isEnglish ? "Master Cycle Detection in Directed Graphs" : "ডিরেক্টেড গ্রাফে সাইকেল ডিটেকশন", _isEnglish ? "Check if processed nodes count equals total V." : "প্রসেসড নোড সংখ্যা V এর সমান কিনা চেক করে সাইকেল চিনুন।"),
            _buildRoadmapStep(4, _isEnglish ? "Master 3-State DFS Cycle Tagging (0, 1, 2)" : "৩-স্টেট DFS কালার ট্যাগের সাইকেল টেস্ট", _isEnglish ? "Detect back-edges using 0=Unvisited, 1=Visiting, 2=Visited." : "৩টি স্টেট মেইনটেইন করে DFS সাইকেল চিনুন।"),
            _buildRoadmapStep(5, _isEnglish ? "Master Graph Construction & Lexicographical Sorting" : "গ্রাফ কনস্ট্রাকশন ও অ্যালিয়েন বর্ণমালা", _isEnglish ? "Build character dependency graph and sort alien dictionary." : "শব্দের তুলনা দিয়ে ক্যারেক্টার গ্রাফ বানিয়ে অ্যালিয়েন বর্ণমালা অর্ডার পান।"),
            const SizedBox(height: 24),
          ],
        ),
      ),
