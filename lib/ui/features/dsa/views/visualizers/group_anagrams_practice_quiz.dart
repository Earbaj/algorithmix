...
class GroupAnagramsPracticeQuiz extends StatefulWidget {
  final bool isEnglish;

  const GroupAnagramsPracticeQuiz({
    super.key,
    required this.isEnglish,
  });

  @override
  State<GroupAnagramsPracticeQuiz> createState() =>
      _GroupAnagramsPracticeQuizState();
}
...
class _GroupAnagramsPracticeQuizState
    extends State<GroupAnagramsPracticeQuiz> {
  int _activeSubTab = 0;
  ...
  final List<TestCaseData> _testCases = const [
    TestCaseData(inputStr: "strs = [\"eat\",\"tea\",\"tan\",\"ate\",\"nat\",\"bat\"]", expectedOutputStr: "[[\"eat\",\"tea\",\"ate\"], [\"tan\",\"nat\"], [\"bat\"]]"),
    TestCaseData(inputStr: "strs = [\"\"]", expectedOutputStr: "[[\"\"]]"),
    TestCaseData(inputStr: "strs = [\"a\"]", expectedOutputStr: "[[\"a\"]]"),
  ];
  ...
  final List<QuizQuestion> _quizQuestions = const [
    QuizQuestion(
      questionEn: "1. Why does sorting the characters of each string form a unique Hash Map key for grouping anagrams?",
      questionBn: "১. প্রতিটি স্ট্রিংয়ের বর্ণ অ্যালফাবেটিক্যালি সর্ট করলে কেন তা একই গ্রুপের জন্য ইউনিক হ্যাশ কী তৈরি করে?",
      optionsEn: [
        "A) All anagram strings contain identical character counts, so sorting their characters yields the exact same canonical string key!",
        "B) Sorting increases the string length",
        "C) It converts characters to integer hash codes",
        "D) It reverses the string order"
      ],
      optionsBn: [
        "A) এনগ্রাম স্ট্রিংগুলোতে একই ক্যারেক্টার থাকে, ফলে সর্ট করলে তারা একই ক্যানোনিকাল কী তৈরি করে!",
        "B) সর্ট করলে স্ট্রিংয়ের দৈর্ঘ্য বাড়ে",
        "C) এটি ক্যারেক্টারকে পূর্ণসংখ্যায় রূপান্তর করে",
        "D) এটি স্ট্রিংয়ের ক্রম উল্টে দেয়"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! \"eat\", \"tea\", and \"ate\" all sort to \"aet\", mapping them directly into the same hash bucket.",
      explanationBn: "সঠিক! \"eat\", \"tea\", \"ate\" সবই সর্ট হয়ে \"aet\" হয়, ফলে তারা একই বাকেটে জমা হয়।",
    ),
    QuizQuestion(
      questionEn: "2. What is the total time complexity of Group Anagrams using sorted keys for N strings of max length K?",
      questionBn: "২. N টি সর্বোচ্চ K দৈর্ঘ্যের স্ট্রিংয়ের জন্য সর্টেড কী হ্যাশ ম্যাপ পদ্ধতির মোট সময় জটিলতা কত?",
      optionsEn: [
        "A) O(N · K log K)",
        "B) O(N^2)",
        "C) O(N · K^2)",
      ...
      correctOptionIndex: 0,
      explanationEn: "Correct! Sorting each of the N strings of length K takes O(K log K), resulting in O(N · K log K) overall time.",
      explanationBn: "সঠিক! N টি স্ট্রিংয়ের প্রতিটিকে K log K সময়ে সর্ট করায় মোট সময় লাগে O(N · K log K)।",
    ),
  ];
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            widget.isEnglish ? "Group Anagrams Quiz" : "গ্রুপ অ্যানাগ্রামস কুইজ",
                            overflow: TextOverflow.ellipsis,
                            maxLines: 1,
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      widget.isEnglish ? "Group Anagrams Test Runner" : "গ্রুপ অ্যানাগ্রামস টেস্ট রানার",
              ...
              Text(
                widget.isEnglish
                    ? "Verify hash bucket grouping logic across diverse string arrays."
                    : "গ্রুপ অ্যানাগ্রামস বাকেট অ্যালগরিদম ভেরিফাই করুন।",
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.isEnglish ? "Group Anagrams Mastery Quiz" : "গ্রুপ অ্যানাগ্রামস মাস্টার কুইজ",
