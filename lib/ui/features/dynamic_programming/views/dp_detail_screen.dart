...
class _DPDetailScreenState extends State<DPDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(_isEnglish ? 'Dynamic Programming Deep Dive' : 'Dynamic Programming গাইড'),
        centerTitle: true,
        actions: [
          Padding(
      ...
      body: TabBarView(
        controller: _tabController,
        children: [
          DPConceptTabView(intro: intro, isEnglish: _isEnglish),
          DPVisualizerTabView(isEnglish: _isEnglish),
          DPProblemsTabView(isEnglish: _isEnglish),
          DPMistakesTabView(isEnglish: _isEnglish),
        ],
      ),
    );
  }
