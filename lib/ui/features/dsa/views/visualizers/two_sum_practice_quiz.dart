...
class TwoSumPracticeQuiz extends StatefulWidget {
  final bool isEnglish;

  const TwoSumPracticeQuiz({
    super.key,
    required this.isEnglish,
  });

  @override
  State<TwoSumPracticeQuiz> createState() => _TwoSumPracticeQuizState();
}
...
class _TwoSumPracticeQuizState extends State<TwoSumPracticeQuiz> {
  int _activeSubTab = 0;
  ...
  final List<TestCaseData> _testCases = const [
    TestCaseData(inputStr: "nums = [2,7,11,15], target = 9", expectedOutputStr: "indices = [0, 1]"),
    TestCaseData(inputStr: "nums = [3,2,4], target = 6", expectedOutputStr: "indices = [1, 2]"),
    TestCaseData(inputStr: "nums = [3,3], target = 6", expectedOutputStr: "indices = [0, 1]"),
  ];
  ...
  final List<QuizQuestion> _quizQuestions = const [
    QuizQuestion(
      questionEn: "1. Why does the Hash Map approach solve Two Sum in O(N) linear time instead of O(N^2)?",
      questionBn: "১. ওয়ান-পাস হ্যাশ ম্যাপ পদ্ধতি কেন টু-সাম সমস্যাটি O(N^2) এর বদলে O(N) লিনিয়ার সময়ে সমাধান করে?",
      optionsEn: [
        "A) Checking if `target - nums[i]` exists in a Hash Map takes O(1) average constant time per element!",
        "B) It sorts the array first in O(N)",
        "C) It uses a nested loop internally",
        "D) It uses binary search on unindexed arrays"
      ],
      optionsBn: [
        "A) হ্যাশ ম্যাপে `target - nums[i]` আছে কিনা তা গড়ে O(1) সময়ে সার্চ করা যায়!",
        "B) এটি প্রথমে অ্যারে O(N) এ সোর্ট করে",
        "C) এটি ভেতরে নেস্টেড লুপ ব্যবহার করে",
        "D) এটি অসংগঠিত অ্যারেতে বাইনারি সার্চ চালায়"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! By storing past numbers in a Hash Map, complement lookup is O(1) instant, avoiding the brute-force nested loop (O(N^2)).",
      explanationBn: "সঠিক! আগে দেখা সংখ্যাগুলো হ্যাশ ম্যাপে রাখায় কমপ্লিমেন্ট খোঁজার কাজ O(1) এ সম্পন্ন হয়।",
    ),
    QuizQuestion(
      questionEn: "2. Why do we store `map[nums[i]] = i` AFTER checking the complement?",
      questionBn: "২. কমপ্লিমেন্ট খোঁজার পর কেন `map[nums[i]] = i` সেভ করা হয়?",
      optionsEn: [
        "A) To prevent matching an element with ITSELF when nums[i] == target / 2!",
        "B) To reverse the array indices",
        "C) To sort keys numerically",
        "D) It makes no difference"
      ],
      optionsBn: [
        "A) যাতে nums[i] == target / 2 হলে একই সংখ্যা নিজের সাথে জোড়া না বানিয়ে নেয়!",
        "B) অ্যারে ইনডেক্স রিভার্স করতে",
        "C) কীগুলোকে সোর্ট করতে",
        "D) এতে কোনো পার্থক্য হয় না"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! If we inserted into the map before checking, target=6 with number 3 would match 3 with itself at index 0!",
      explanationBn: "সঠিক! আগে ইনসার্ট করলে, টার্গেট ৬ ও সংখ্যা ৩ এর ক্ষেত্রে ০ ইনডেক্স নিজেকেই জোড়া বানিয়ে ভুল ফলাফল দিত।",
    ),
  ];
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            widget.isEnglish ? "Two Sum Map Quiz" : "টু-সাম ম্যাপ কুইজ",
                            overflow: TextOverflow.ellipsis,
                            maxLines: 1,
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      widget.isEnglish ? "Two Sum Test Runner" : "টু-সাম টেস্ট রানার",
              ...
              Text(
                widget.isEnglish
                    ? "Verify hash map complement lookup for different array sizes and target values."
                    : "হ্যাশ ম্যাপ কমপ্লিমেন্ট অ্যালগরিদম বিভিন্ন টেস্ট কেসে ভেরিফাই করুন।",
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.isEnglish ? "Two Sum Map Mastery Quiz" : "টু-সাম ম্যাপ মাস্টার কুইজ",
