...
class NextGreaterElementPracticeQuiz extends StatefulWidget {
  final bool isEnglish;

  const NextGreaterElementPracticeQuiz({
    super.key,
    required this.isEnglish,
  });

  @override
  State<NextGreaterElementPracticeQuiz> createState() =>
      _NextGreaterElementPracticeQuizState();
}
...
class _NextGreaterElementPracticeQuizState extends State<NextGreaterElementPracticeQuiz> {
  int _activeSubTab = 0;
  ...
  final List<TestCaseData> _testCases = const [
    TestCaseData(inputStr: "[2, 1, 2, 4, 3]", expectedOutputStr: "[4, 2, 4, -1, -1]"),
    TestCaseData(inputStr: "[1, 3, 4, 2]", expectedOutputStr: "[3, 4, -1, -1]"),
    TestCaseData(inputStr: "[5, 4, 3, 2, 1] (Decreasing)", expectedOutputStr: "[-1, -1, -1, -1, -1]"),
  ];
  ...
  final List<QuizQuestion> _quizQuestions = const [
    QuizQuestion(
      questionEn: "1. Why does the Monotonic Stack algorithm run in amortized O(N) time even with a while loop inside?",
      questionBn: "১. স্ট্যাকের ভেতরে while লুপ থাকা সত্ত্বেও Monotonic Stack অ্যালগরিদম কেন ওয়ান (Amortized O(N)) টাইমে কাজ করে?",
      optionsEn: [
        "A) Each element is pushed ONCE and popped AT MOST ONCE overall (total <= 2N operations)!",
        "B) Because the while loop runs only 1 time",
        "C) Because it uses recursion",
        "D) It takes O(N^2) worst case"
      ],
      optionsBn: [
        "A) প্রতিটি উপাদান পুরো অ্যালগরিদমে সর্বোচ্চ একবার পুশ ও একবার পপ হয় (মোট <= 2N অপারেশন)! ",
        "B) কারণ while লুপ কেবল ১ বার চলে",
        "C) কারণ এটি রিকার্শন ব্যবহার করে",
        "D) ওয়ার্স্ট কেসে O(N^2) লাগে"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! Every element is pushed onto the stack exactly once and popped at most once, guaranteeing total 2N operations across the entire array pass.",
      explanationBn: "সঠিক! অ্যারের প্রতিটি ইলিমেন্ট স্ট্যাকে সর্বোচ্চ ১ বার ঢোকে ও ১ বার পপ হয়, তাই মোট অপারেশন সংখ্যা 2N এর বেশি হতে পারে না (Amortized O(N))।",
    ),
    QuizQuestion(
      questionEn: "2. Why do we traverse the array Right-to-Left when building Next Greater Element?",
      questionBn: "২. Next Greater Element বের করার সময় কেন অ্যারেতে ডান থেকে বামে (Right-to-Left) হাঁটতে হয়?",
      optionsEn: [
        "A) To ensure future (right-side) elements are already processed and available inside the stack!",
        "B) Left to right gives wrong answer",
        "C) To save memory",
        "D) Right to left is faster"
      ],
      optionsBn: [
        "A) যাতে ডানের (পরবর্তী) উপাদানগুলো আগেই স্ট্যাকে প্রক্রিয়াজাত অবস্থায় সংরক্ষিত থাকে!",
        "B) বাম থেকে ডানে ভুল উত্তর দেয়",
        "C) মেমোরি সাশ্রয় করতে",
        "D) ডান থেকে বামে দ্রুত চলে"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! Traversing right-to-left builds the stack with right-side candidates ready for immediate top lookup for elements on the left.",
      explanationBn: "সঠিক! ডান থেকে বামে ট্রাভার্স করায় বামের নোডের জন্য ডানের সমস্ত ক্যান্ডিডেট উপাদানগুলো আগেই স্ট্যাকে প্রস্তুত থাকে।",
    ),
  ];
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            widget.isEnglish ? "Monotonic Stack Quiz" : "মনোটোনিক স্ট্যাক কুইজ",
                            overflow: TextOverflow.ellipsis,
                            maxLines: 1,
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      widget.isEnglish ? "Next Greater Element Test Runner" : "Next Greater Element টেস্ট রানার",
              ...
              Text(
                widget.isEnglish
                    ? "Verify monotonic stack execution against random, sorted, and decreasing arrays."
                    : "মনোটোনিক স্ট্যাক লজিক র্যান্ডম ও সর্টেড অ্যারের ওপর ভেরিফাই করুন।",
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.isEnglish ? "Monotonic Stack Mastery Quiz" : "মনোটোনিক স্ট্যাক মাস্টার কুইজ",
