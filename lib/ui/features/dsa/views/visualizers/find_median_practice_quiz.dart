...
class FindMedianPracticeQuiz extends StatefulWidget {
  final bool isEnglish;

  const FindMedianPracticeQuiz({
    super.key,
    required this.isEnglish,
  });

  @override
  State<FindMedianPracticeQuiz> createState() =>
      _FindMedianPracticeQuizState();
}
...
class _FindMedianPracticeQuizState
    extends State<FindMedianPracticeQuiz> {
  int _activeSubTab = 0;
  ...
  final List<TestCaseData> _testCases = const [
    TestCaseData(inputStr: "addNum(1), addNum(2), findMedian()", expectedOutputStr: "1.5"),
    TestCaseData(inputStr: "addNum(3), findMedian()", expectedOutputStr: "2.0"),
    TestCaseData(inputStr: "addNum(5), addNum(15), addNum(10), addNum(20), findMedian()", expectedOutputStr: "12.5"),
  ];
  ...
  final List<QuizQuestion> _quizQuestions = const [
    QuizQuestion(
      questionEn: "1. Why does the Two-Heap design allow `findMedian()` to run in O(1) constant time?",
      questionBn: "১. Two-Heap ডিজাইন কীভাবে `findMedian()` কে O(1) সময়ের মধ্যে রান করায়?",
      optionsEn: [
        "A) Because the Max-Heap root holds the max of the lower half and the Min-Heap root holds the min of the upper half in O(1) instant access!",
        "B) Because sorting is updated lazily",
        "C) Because arrays automatically re-index",
        "D) Because Python heapq is multi-threaded"
      ],
      optionsBn: [
        "A) কারণ Max-Heap এর রুট ছোট অর্ধেকের সেরা মান এবং Min-Heap এর রুট বড় অর্ধেকের সর্বনিম্ন মান O(1) এ ধরে রাখে!",
        "B) কারণ সর্টিং পরবর্তীতে করা হয়",
        "C) কারণ অ্যারে অটোমেটিক রি-ইনডেক্স হয়",
        "D) কারণ heapq মাল্টি-থ্রেডেড"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! Peeking top elements from both heaps takes O(1) constant time, making median calculation instant.",
      explanationBn: "সঠিক! দুটি হিপের রুট পীক করতে মাত্র O(1) সময় লাগে, ফলে তাৎক্ষণিকভাবে মিডিয়ান পাওয়া যায়।",
    ),
    QuizQuestion(
      questionEn: "2. How is heap balance maintained when elements are continuously added via `addNum(num)`?",
      questionBn: "২. কীভাবে `addNum(num)` দিয়ে ক্রমাগত উপাদান যুক্ত হলেও হিপ ব্যালেন্স বজায় থাকে?",
      optionsEn: [
        "A) Max-Heap size is kept equal to or at most 1 greater than Min-Heap size by shifting top elements whenever needed!",
        "B) Heaps are rebuilt completely from scratch",
        "C) Elements are randomly discarded",
        "D) Min-Heap size is doubled"
      ],
      optionsBn: [
        "A) প্রয়োজনে টপ এলিমেন্ট ট্রান্সফার করে Max-Heap এর সাইজকে সবসময় Min-Heap এর সমান বা সর্বোচ্চ ১ বেশি রাখা হয়!",
        "B) প্রতিবার সম্পূর্ণ হিপ নতুন করে তৈরি হয়",
        "C) উপাদান র‍্যান্ডম রিমুভ করা হয়",
        "D) Min-Heap এর সাইজ দ্বিগুণ করা হয়"
      ],
      correctOptionIndex: 0,
      explanationEn: "Correct! The invariant enforces that `abs(maxHeap.size - minHeap.size) <= 1` after every insertion in O(log N) time.",
      explanationBn: "সঠিক! প্রতি ইনসার্ট শেষে হিপ দুটির আকারের পার্থক্য সর্বোচ্চ ১ নিশ্চিত করা হয় (O(log N))।",
    ),
  ];
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            widget.isEnglish ? "Find Median Quiz" : "ফাইন্ড মিডিয়ান কুইজ",
                            overflow: TextOverflow.ellipsis,
                            maxLines: 1,
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      widget.isEnglish ? "Find Median Test Runner" : "ফাইন্ড মিডিয়ান টেস্ট রানার",
              ...
              Text(
                widget.isEnglish
                    ? "Verify Two-Heaps stream median balancing logic."
                    : "Two-Heaps দিয়ে ডেটা স্ট্রিম মিডিয়ান ব্যালেন্সিং টেস্ট করুন।",
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.isEnglish ? "Find Median Mastery Quiz" : "ফাইন্ড মিডিয়ান মাস্টার কুইজ",
