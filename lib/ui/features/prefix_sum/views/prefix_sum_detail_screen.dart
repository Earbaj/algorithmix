...
class _PrefixSumDetailScreenState extends State<PrefixSumDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(_isEnglish ? 'Prefix Sum Deep Dive' : 'Prefix Sum গাইড'),
        centerTitle: true,
        actions: [
          Padding(
      ...
      body: TabBarView(
        controller: _tabController,
        children: [
          PrefixConceptTabView(intro: intro, isEnglish: _isEnglish),
          PrefixVisualizerTabView(isEnglish: _isEnglish),
          PrefixProblemsTabView(isEnglish: _isEnglish),
          PrefixMistakesTabView(isEnglish: _isEnglish),
        ],
      ),
    );
  }
