...
import 'package:algorithmix/domain/models/kway_merge_data.dart';
...
class _KWayMergeDetailScreenState extends State<KWayMergeDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(_isEnglish ? 'K-Way Merge Pattern Deep Dive' : 'K-Way Merge গাইড'),
        centerTitle: true,
        actions: [
          Padding(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildCodeBox("Template 1: Merge k Sorted Lists (C++ LeetCode 23)", """
...
ListNode* mergeKLists(vector<ListNode*>& lists) {
    ...
    return dummy.next;
            ...
            _buildCodeBox("Template 2: Kth Smallest Element in a Sorted Matrix (C++ LeetCode 378)", """
int kthSmallest(vector<vector<int>>& matrix, int k) {
    ...
    return get<0>(minHeap.top());
            ...
            const SizedBox(height: 16),
            _buildCodeBox("Template 3: Smallest Range Covering Elements from K Lists (C++ LeetCode 632)", """
vector<int> smallestRange(vector<vector<int>>& nums) {
  ...
  Widget _buildVisualizerTab() {
    ...
    return ResponsiveCenter(
      padding: EdgeInsets.all(hPadding),
      child: SingleChildScrollView(
        child: KWayMergeVisualizer(isEnglish: _isEnglish),
      ),
    );
  }
  ...
  Widget _buildProblemSection(String title, List<KWayMergeProblem> problems, Color diffColor) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Widget _buildProblemCard(KWayMergeProblem p, Color diffColor) {
    return Container(
  ...
  Widget _buildMistakesTab() {
    final hPadding = Responsive.horizontalPadding(context);
    final mistakes = KWayMergeData.getCommonMistakes(_isEnglish);
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildRoadmapStep(1, _isEnglish ? "Master Struct/Tuple Custom Comparator for Min-Heap" : "কাস্টম কম্পারেটর হিপ সিনট্যাক্স", _isEnglish ? "Define custom comparator struct for Min-Heap with pointers or tuples." : "পয়েন্টার বা টিউপল হিপের জন্য কাস্টম ফানক্টর শিখুন।"),
            _buildRoadmapStep(2, _isEnglish ? "Master 2-Way Sorted List Merge" : "২-ওয়ে লিঙ্কড লিস্ট মার্জ", _isEnglish ? "Merge two sorted lists using dummy head and iteration." : "ডামি হেডের মাধ্যমে ২টি লিস্ট মার্জ সম্পন্ন করুন।"),
            _buildRoadmapStep(3, _isEnglish ? "Master Merge K Sorted Lists (LeetCode 23)" : "K টি সর্টেড লিস্ট মার্জ (LeetCode 23)", _isEnglish ? "Pop min node from heap and push node->next in O(N log K)." : "K সাইজের Min-Heap দিয়ে O(N log K) সময়ে লিস্ট মার্জ করুন।"),
            _buildRoadmapStep(4, _isEnglish ? "Master Sorted Matrix K-Way Merge" : "সর্টেড ম্যাট্রিক্স K-Way মার্জ", _isEnglish ? "Push 1st column of matrix into Min-Heap and pop K times." : "ম্যাট্রিক্সের ১ম কলাম হিপে রেখে K বার পপ করুন।"),
            _buildRoadmapStep(5, _isEnglish ? "Master Dynamic Boundary Squeezing (Smallest Range)" : "ডাইনামিক বাউন্ডারি কভারিং রেঞ্জ (LeetCode 632)", _isEnglish ? "Track currentMax alongside Min-Heap to find smallest covering range." : "Min-Heap এর সাথে currentMax মেপে কভারিং রেঞ্জ ফিল্টার করুন।"),
            const SizedBox(height: 24),
          ],
        ),
      ),
