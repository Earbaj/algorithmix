...
class CombinationSumVisualizer extends StatefulWidget {
  final bool isEnglish;

  const CombinationSumVisualizer({super.key, required this.isEnglish});

  @override
  State<CombinationSumVisualizer> createState() => _CombinationSumVisualizerState();
}

class _CombinationSumVisualizerState extends State<CombinationSumVisualizer> {
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text("Combination Path [curr]: [${step.currentPath.join(', ')}]", style: const TextStyle(color: AppTheme.accentNeonCyan, fontWeight: FontWeight.bold, fontSize: 13)),
              const Text("Target Sum: 7", style: TextStyle(color: AppTheme.accentAmber, fontWeight: FontWeight.bold, fontSize: 13)),
            ],
          ),
          const SizedBox(height: 16),
          const Text("Matching Target Combinations:", style: TextStyle(color: AppTheme.textSecondary, fontSize: 12)),
