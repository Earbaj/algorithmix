...
class _TopKElementsDetailScreenState extends State<TopKElementsDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(_isEnglish ? 'Top K Elements Deep Dive' : 'Top K Elements গাইড'),
        centerTitle: true,
        actions: [
          Padding(
      ...
      body: TabBarView(
        controller: _tabController,
        children: [
          TopKElementsConceptTabView(intro: intro, isEnglish: _isEnglish),
          TopKElementsVisualizerTabView(isEnglish: _isEnglish),
          TopKElementsProblemsTabView(isEnglish: _isEnglish),
          TopKElementsMistakesTabView(isEnglish: _isEnglish),
        ],
      ),
    );
  }
