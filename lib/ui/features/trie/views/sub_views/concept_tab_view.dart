...
class TrieConceptTabView extends StatelessWidget {
  final Map<String, String> intro;
  final bool isEnglish;

  const TrieConceptTabView({
    super.key,
    required this.intro,
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildCodeBox("Template 1: Standard Trie Class (26-Child Array + isEnd)", """
struct TrieNode {
...
public:
    ...
    bool startsWith(string prefix) {
        TrieNode* curr = root;
        for (char c : prefix) { if (!curr->children[c - 'a']) return false; curr = curr->children[c - 'a']; }
        return true;
    }
};"""),
            const SizedBox(height: 16),
            _buildCodeBox("Template 2: Wildcard Search Trie DFS (LeetCode 211)", """
bool searchHelp(string& word, int idx, TrieNode* curr) {
    ...
    return false;
            ...
            const SizedBox(height: 16),
            _buildCodeBox("Template 3: Bitwise Binary Trie for Maximum XOR (LeetCode 421)", """
